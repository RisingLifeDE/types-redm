 ...
 */
export declare function doesEntityExist(entity: number | Object): boolean;
/**
 ...
 */
export declare function getVehicleDashboardColour(vehicle: number | Vehicle, color: number): void;
/**
 ...
 */
export declare function getVehicleCustomSecondaryColour(vehicle: number | Vehicle, r: number, g: number, b: number): void;
/**
 * No comment provided
 *
 ...
 */
export declare function getVehicleColours(vehicle: number | Vehicle, colorPrimary: number, colorSecondary: number): void;
/**
 * No comment provided
 *
 ...
 */
export declare function getVehicleExtraColours(vehicle: number | Vehicle, pearlescentColor: number, wheelColor: number): void;
/**
 ...
 */
export declare function getVehicleLightsState(vehicle: number | Vehicle, lightsOn: boolean, highbeamsOn: boolean): boolean;
/**
 * No comment provided
 *
 ...
 */
export declare function getVehicleCustomPrimaryColour(vehicle: number | Vehicle, r: number, g: number, b: number): void;
/**
 ...
 */
export declare function getVehicleNeonColour(vehicle: number | Vehicle, red: number, green: number, blue: number): void;
/**
 ...
 */
export declare function getVehicleTyreSmokeColor(vehicle: number | Vehicle, r: number, g: number, b: number): void;
/**
 * No comment provided
 *
 ...
 */
export declare function getVehicleInteriorColour(vehicle: number | Vehicle, color: number): void;
/**
 * No comment provided
 *
 ...
 */
export declare function createVehicleServerSetter(modelHash: number | string, type: string, pos: Vector3, heading: number): number;
/**
 * No comment provided
 *
 ...
 */
export declare function applyForceToEntity(entity: number | Entity, forceType: number, pos: Vector3, offX: number, offY: number, offZ: number, nComponent: number, bLocalForce: boolean, bLocalOffset: boolean, bScaleByMass: boolean, bPlayAudio: boolean, bScaleByTimeWarp: boolean): void;
/**
