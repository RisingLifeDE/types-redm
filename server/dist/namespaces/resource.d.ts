 ...
 * Hash: 0xE27C97A0
 */
export declare function flushKvp(): void;
/**
 * Returns the physical on-disk path of the specified resource.
 *
 * Hash: 0x61DCF017
 */
export declare function getPath(resourceName: string): string;
/**
 ...
 * Hash: 0x9862B266
 */
export declare function registerAsset(resourceName: string, fileName: string): string;
/**
 ...
 * Hash: 0x285B43CA
 */
export declare function registerBuildTaskFactory(factoryId: string, factoryFn: Function): void;
/**
 ...
 * Hash: 0xA09E7E7B
 */
export declare function saveFile(resourceName: string, fileName: string, data: string, dataLength: number): boolean;
/**
 ...
 * Hash: 0x636F097F
 */
export declare function scanRoot(rootPath: string, callback: Function): void;
/**
 * Schedules the specified resource to run a tick as soon as possible, bypassing the server's fixed tick rate.
 *
 * Hash: 0xB88A73AD
 */
export declare function scheduleTick(resourceName: string): void;
/**
 * No comment provided
 *
 * Hash: 0x29B440DC
 */
export declare function start(resourceName: string): boolean;
/**
 * No comment provided
 *
 * Hash: 0x21783161
 */
export declare function stop(resourceName: string): boolean;
/**
 * No comment provided
 *
 * Hash: 0x7389B5DF
