 ...
 * Hash: 0xB8689B4E
 */
export declare function enterVehicle(ped: number | IPed, vehicle: number | IVehicle, timeout: number, seatIndex: number, speed: number, flag: number): void;
/**
 ...
 * Hash: 0xF91DF93B
 */
export declare function goToCoordAnyMeans(ped: number | IPed, pos: Vector3, fMoveBlendRatio: number, vehicle: number | IVehicle, bUseLongRangeVehiclePathing: boolean, drivingFlags: number, fMaxRangeToShootTargets: number): void;
/**
 * ```
 ...
 * Hash: 0x374827C2
 */
export declare function goToEntity(entity: number | IEntity, target: number | IEntity, duration: number, distance: number, speed: number): void;
/**
 * ```
 ...
 * Hash: 0x8DCC19C5
 */
export declare function handsUp(ped: number | IPed, duration: number, facingPed: number | IPed): void;
/**
 ...
 * Hash: 0xDBDD79FA
 */
export declare function leaveAnyVehicle(ped: number | IPed, flags: number): void;
/**
 * ```
 ...
 * Hash: 0x3DDEB0E6
 */
export declare function playAnimAdvanced(ped: number | IPed, animDictionary: string, animationName: string, pos: Vector3, rot: Vector3, blendInSpeed: number, blendOutSpeed: number, duration: number, flag: any, animTime: number): void;
/**
 ...
 * Hash: 0x65D4A35D
 */
export declare function warpPedIntoVehicle(ped: number | IPed, vehicle: number | IVehicle, seatIndex: number): void;
