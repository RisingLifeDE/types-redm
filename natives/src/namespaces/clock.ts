 ...
 */
export function pause(toggle: boolean, unused: any): void {
 ...
 */
export function addTimeToDateTime(): [any, any, any] {
 ...
 */
export function getPosixTimeStruct(): any {
 ...
 */
export function pauseThisFrame(toggle: boolean): void {
