 ...
 */
export function copyMpInventoryToMissionInventory(bCopySatchelItems: boolean, bCopyEmotes: boolean, bCopyHorse: boolean): void {
 ...
 */
export function disableMissionInventoryPickups(): void {
 ...
 */
export function getChildrenInSlotCount(inventoryId: number, slotId: number | string): [number, any] {
 ...
 */
export function getGuidFromItemid(inventoryId: number, p2: number | string, slotId: number | string): [boolean, any, any] {
 ...
 */
export function getInventoryItem(inventoryId: number): [boolean, any, any] {
 ...
 */
export function _0x0349404A22736740(inventoryId: number): any {
 ...
 */
export function _0x46DB71883EE9D5AF(data: any, stats: string, ped: number | IPed): [number, any] {
 ...
 */
export function _0x6862E4D93F64CF01(inventoryId: number, p2: number | string): [boolean, any, any] {
    if (typeof p2 === 'string') p2 = GetHashKey(p2)
 ...
 */
export function _0x6968CE7AC32F6788(inventoryId: number): void {
 ...
 */
export function _0x951847CEF3D829FF(ped: number | IPed): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x9B4E793B1CB6550A(): void {
 ...
 */
export function _0x9E58207B194488AC(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xB1DD74A1F5536622(inventoryId: number): [boolean, any] {
 ...
 */
export function _0xD08685BA892DBFAB(inventoryId: number): [boolean, any, number, number] {
 ...
 */
export function _0xE1F45A67A9F0DCBC(inventoryId: number): void {
 ...
 */
export function getDefaultItemSlotInfo(item: number | string, p1: number | string): number {
 ...
 */
export function getItemRoleMaxLevelCount(inventoryId: number, eRoleMaxLevel: number | string): number {
    if (typeof eRoleMaxLevel === 'string') eRoleMaxLevel = GetHashKey(eRoleMaxLevel)
 ...
 */
export function getItemSlotMaxCount(provision: number | string, slotId: number | string): number {
    if (typeof provision === 'string') provision = GetHashKey(provision)
    if (typeof slotId === 'string') slotId = GetHashKey(slotId)
 ...
 */
export function addCatalogItemInspectionEffectsEntry(entryId: number, name: string, unk1: boolean, unk2: boolean): number {
 ...
 */
export function addCatalogItemInspectionStatsEntry(entryId: number, name: string, unk1: number, playerid: number | string | IPlayer): number {
 ...
 */
export function addItemWithGuid(inventoryId: number, item: number | string, inventoryItemSlot: number | string, addReason: number | string): [boolean, any, any] {
    if (typeof item === 'string') item = GetHashKey(item)
    if (typeof inventoryItemSlot === 'string') inventoryItemSlot = GetHashKey(inventoryItemSlot)
 ...
 */
export function applyItemEffectToStatsEntry(databindingEntryId: number | string): void {
    if (typeof databindingEntryId === 'string') databindingEntryId = GetHashKey(databindingEntryId)
 ...
 */
export function applyWeaponStatsToEntry(entryId: number, weapon: number | string, ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function areLocalChangesAllowed(inventoryId: number): boolean {
 ...
 */
export function compareGuids(): [boolean, any, any] {
 ...
 */
export function copyItemToInventory(inventoryId: number, inventoryIdCloned: number): any {
 ...
 */
export function copyItemToMissionInventory(): any {
 ...
 */
export function createItemCollection(inventoryId: number, filterName: string, slotId: number | string): [number, number] {
    if (typeof slotId === 'string') slotId = GetHashKey(slotId)
 ...
 */
export function createItemCollection2(): [number, number] {
 ...
 */
export function createItemCollectionWithFilter(inventoryId: number): [number, any, number] {
 ...
 */
export function createSortedCollection(inventoryId: number): [number, number] {
 ...
 */
export function disableItem(inventoryId: number, item: number | string, gtxReason: number | string): void {
    if (typeof item === 'string') item = GetHashKey(item)
    if (typeof gtxReason === 'string') gtxReason = GetHashKey(gtxReason)
 ...
 */
export function disableWeapons(inventoryId: number): void {
 ...
 */
export function doesItemOwnEquipment(inventoryId: number, item: number | string): [boolean, any] {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function enableItem(inventoryId: number, item: number | string): void {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function enableWeapons(inventoryId: number): void {
 ...
 */
export function equipItemWithGuid(inventoryId: number, bEquipped: boolean): [boolean, any] {
 ...
 */
export function fitsSlotId(item: number | string, slotId: number | string): boolean {
    if (typeof item === 'string') item = GetHashKey(item)
    if (typeof slotId === 'string') slotId = GetHashKey(slotId)
 ...
 */
export function getChildrenCount(inventoryId: number): [number, any] {
 ...
 */
export function getFullInventoryItemData(inventoryId: number): [boolean, any, any] {
 ...
 */
export function getInventoryIdFromPed(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getInventoryItemChild(inventoryId: number, childIndex: any): [boolean, any, any] {
 ...
 */
export function getInventoryItemCompatibleSlots(item: number | string, maxResults: number): [boolean, any] {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getInventoryItemCountWithGuid(inventoryId: number): [number, any] {
 ...
 */
export function getInventoryItemCountWithItemid(inventoryId: number, eInventoryItem: number | string): number {
    if (typeof eInventoryItem === 'string') eInventoryItem = GetHashKey(eInventoryItem)
 ...
 */
export function getInventoryItemDescriptionHash(item: number | string): number {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getInventoryItemEquippedInSlot(inventoryId: number, slotId: number | string): [number, any, any] {
    if (typeof slotId === 'string') slotId = GetHashKey(slotId)
 ...
 */
export function getInventoryItemEquippedInSlotByRef(inventoryId: number, slotId: number | string): [boolean, any, any] {
    if (typeof slotId === 'string') slotId = GetHashKey(slotId)
 ...
 */
export function getInventoryItemFitSlot(p0: number | string): [boolean, any] {
 ...
 */
export function getInventoryItemHidden(inventoryId: number): [boolean, any] {
 ...
 */
export function getInventoryItemInspectionInfo(item: number | string): [boolean, any] {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getInventoryItemInUse(inventoryId: number): [boolean, any] {
 ...
 */
export function getInventoryItemIsAnimalPelt(item: number | string): boolean {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getInventoryItemLastCreation(inventoryId: number, item: number | string): [boolean, number, number, number, number, number, number] {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getInventoryItemSound(item: number | string, soundType: number): number {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getInventoryItemWeaponCopyId(inventoryId: number): [number, any] {
 ...
 */
export function getIsInventoryItemSoundValid(item: number | string, soundType: number): boolean {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function getItemExpiryTime(): [number, any] {
 ...
 */
export function getItemFromCollectionIndex(collectionId: number, itemIndex: number): [boolean, any] {
 ...
 */
export function isGuidValid(): [boolean, any] {
 ...
 */
export function isInventoryItemEquipped(inventoryId: number, item: number | string): boolean {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function isInventoryItemFlagEnabled(item: number | string, flag: number): boolean {
    if (typeof item === 'string') item = GetHashKey(item)
 ...
 */
export function isItemExpired(): [boolean, any] {
 ...
 */
export function isPlayerInventoryMirroringTransactions(): boolean {
 ...
 */
export function isUsingBackupInventory(): boolean {
 ...
 */
export function moveInventoryItem(inventoryId: number, slotId: number | string, quantity: number): [boolean, any, any, any] {
    if (typeof slotId === 'string') slotId = GetHashKey(slotId)
 ...
 */
export function releaseItemCollection(collectionId: number): boolean {
 ...
 */
export function removeInventoryItems(inventoryId: number, removeReason: number | string): boolean {
 ...
 */
export function removeInventoryItemWithGuid(inventoryId: number, quantity: number, removeReason: number | string): [boolean, any] {
    if (typeof removeReason === 'string') removeReason = GetHashKey(removeReason)
 ...
 */
export function removeInventoryItemWithItemid(inventoryId: number, item: number | string, quantity: number, removeReason: number | string): boolean {
    if (typeof item === 'string') item = GetHashKey(item)
    if (typeof removeReason === 'string') removeReason = GetHashKey(removeReason)
 ...
 */
export function setInventoryItemHidden(inventoryId: number, hidden: boolean): any {
 ...
 */
export function setInventoryItemHidden2(inventoryId: number, hidden: boolean): any {
 ...
 */
export function setInventoryItemInspectionEnabled(inventoryId: number, enabled: boolean): [boolean, any] {
 ...
 */
export function setInventoryItemInUse(inventoryId: number, inUse: boolean): any {
 ...
 */
export function setInventoryItemWeatherEffectiveness(inventoryId: number, weatherEffectiveness: number): any {
 ...
 */
export function swapInventoryItem(inventoryId: number): [boolean, any, any] {
 ...
 */
export function updateInventoryItem(inventoryId: number): [boolean, any, any] {
 ...
 */
export function useBackupInventory(): void {
 ...
 */
export function useMissionInventory(enable: boolean, mirrorTransactions: boolean): void {
 ...
 */
export function useSatchelItem(inventoryId: number, eInventoryItem: number | string): void {
    if (typeof eInventoryItem === 'string') eInventoryItem = GetHashKey(eInventoryItem)
 ...
 */
export function setCarriableCarryActionPromptOverride(): any {
 ...
 */
export function setItemPromptInfoRequest(): any {
 ...
 */
export function setUseMission(toggle: boolean): void {
