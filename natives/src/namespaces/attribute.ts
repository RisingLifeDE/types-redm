 ...
 */
export function addPoints(ped: number | IPed, attributeIndex: number): void {
 ...
 */
export function disableOverpower(ped: number | IPed, attributeIndex: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function enableOverpower(ped: number | IPed, attributeIndex: number, value: number, makeSound: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getBaseRank(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getBonusRank(ped: number | IPed, coreIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPoints(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getRank(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getDefaultPointsNeededForRank(modelHash: number | string, attributeIndex: number, rank: number): number {
 ...
 */
export function getDefaultRank(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getDefaultMaxRank(modelHash: number | string, attributeIndex: number): number {
    if (typeof modelHash === 'string') modelHash = GetHashKey(modelHash)
 ...
 */
export function getMaxPoints(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getMaxRank(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setBaseRank(ped: number | IPed, attributeIndex: number, newValue: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setBonusRank(ped: number | IPed, attributeIndex: number, newValue: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setPoints(ped: number | IPed, attributeIndex: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function enableCoreOverpower(ped: number | IPed, coreIndex: number, value: number, makeSound: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCoreOverpowerSecondsLeft(ped: number | IPed, coreIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCoreValue(ped: number | IPed, coreIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getOverpowerSecondsLeft(ped: number | IPed, attributeIndex: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isCoreOverpowered(ped: number | IPed, coreIndex: number): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isOverpowered(ped: number | IPed, attributeIndex: number): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setCoreValue(ped: number | IPed, coreIndex: number, value: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function startItemPreview(): void {
