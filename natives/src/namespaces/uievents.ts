 ...
 */
export function eventsUiGetMessage(hash: number | string): [boolean, any] {
 ...
 */
export function eventsUiIsPending(hash: number | string): boolean {
    if (typeof hash === 'string') hash = GetHashKey(hash)
 ...
 */
export function eventsUiPeekMessage(hash: number | string): [boolean, any] {
    if (typeof hash === 'string') hash = GetHashKey(hash)
 ...
 */
export function eventsUiPopMessage(hash: number | string): void {
    if (typeof hash === 'string') hash = GetHashKey(hash)
