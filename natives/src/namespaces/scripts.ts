 ...
 */
export function awardsGetResultItem(awardHash: number | string, itemIndex: number): [boolean, any, any] {
    if (typeof awardHash === 'string') awardHash = GetHashKey(awardHash)
 ...
 */
export function bgGetScriptIdFromNameHash(p0: number | string): number {
 ...
 */
export function countParticipantBits(): [number, any] {
 ...
 */
export function countPlayerBits(): [number, any] {
 ...
 */
export function doesScriptExist(): [boolean, string] {
 ...
 */
export function doesScriptWithNameHashExist(scriptHash: number | string): boolean {
 ...
 */
export function getBlockOfPlayerBits(): [number, any] {
 ...
 */
export function getEventExists(eventGroup: number, eventType: number | string): boolean {
 ...
 */
export function getNumberOfThreadsRunningTheScriptWithThisHash(scriptHash: number | string): number {
    if (typeof scriptHash === 'string') scriptHash = GetHashKey(scriptHash)
 ...
 */
export function getThreadExistenceDetails(threadId: number): [boolean, boolean] {
 ...
 */
export function hasScriptLoaded(): [boolean, string] {
 ...
 */
export function hasScriptWithNameHashLoaded(scriptHash: number | string): boolean {
    if (typeof scriptHash === 'string') scriptHash = GetHashKey(scriptHash)
 ...
 */
export function haveAllChildTerminated(): boolean {
 ...
 */
export function requestScriptWithNameHash(scriptHash: number | string): void {
    if (typeof scriptHash === 'string') scriptHash = GetHashKey(scriptHash)
 ...
 */
export function setBlockOfPlayerBits(): any {
 ...
 */
export function setEventFlagForDeletion(eventGroup: number, eventIndex: number): void {
 ...
 */
export function setScriptWithNameHashAsNoLongerNeeded(scriptHash: number | string): void {
    if (typeof scriptHash === 'string') scriptHash = GetHashKey(scriptHash)
 ...
 */
export function stopDisplayingMpTransitionLoadingScreens(): void {
 ...
 */
export function triggerScriptEvent(eventGroup: number, eventDataSize: number, scriptMetadataIndex: number): [any, number] {
 ...
 */
export function _0x0A79C81C418F5D38(): any {
 ...
 */
export function _0x11B0A0B282FA9B10(): void {
 ...
 */
export function _0x1BDB5A07307F6929(): void {
 ...
 */
export function _0x1C5EB3C27F7508CB(): void {
 ...
 */
export function _0x29FB4CE89472C3CB(): void {
 ...
 */
export function _0x42A429CDFED6D99D(): void {
 ...
 */
export function _0x5827BE85A87B073D(): void {
 ...
 */
export function _0x64F765D9A1F8F02C(): [any, any, any] {
 ...
 */
export function _0x6F700A4BF7C3331B(): void {
 ...
 */
export function _0x76CBCD9EADC00955(): void {
 ...
 */
export function _0xA88E1D7FA1E20080(): any {
 ...
 */
export function _0xE4ABE20DCE7C7CFE(): void {
 ...
 */
export function _0xE7282390542F570D(): any {
 ...
 */
export function _0xF9E951A1E5517C06(): void {
 ...
 */
export function _0xFFDDF802279BE128(): void {
 ...
 */
export function activateGoalContext(goalContext: number | string): void {
    if (typeof goalContext === 'string') goalContext = GetHashKey(goalContext)
 ...
 */
export function awardsGetUnlockClaimData(awardHash: number | string, dataIndex: number): [boolean, any, any] {
    if (typeof awardHash === 'string') awardHash = GetHashKey(awardHash)
 ...
 */
export function bgReloadAllBackground(): void {
 ...
 */
export function clearAllPlayerBits(): any {
 ...
 */
export function clearPlayerBitAtIndex(bitIndex: number): any {
 ...
 */
export function deactivateGoalContext(goalContext: number | string): void {
    if (typeof goalContext === 'string') goalContext = GetHashKey(goalContext)
 ...
 */
export function displayLoadingScreens(p0: number | string, p1: number | string, p2: number | string, gamemodeName: string, title: string, subtitle: string): void {
    if (typeof p0 === 'string') p0 = GetHashKey(p0)
 ...
 */
export function isAnyPlayerBitSet(): [boolean, number] {
 ...
 */
export function isGoalContextActive(goalContext: number | string): boolean {
    if (typeof goalContext === 'string') goalContext = GetHashKey(goalContext)
 ...
 */
export function isPlayerBitSetAtIndex(bitIndex: number): [boolean, any] {
 ...
 */
export function lootGetLootClaimData(dataIndex: number): [boolean, any, any] {
 ...
 */
export function lootGetResultItem(itemIndex: number): [boolean, any, any] {
 ...
 */
export function netRpcGuidToString(): [string, any] {
 ...
 */
export function requestThreadExitForAllThreadsWithThisName(nameHash: number | string): void {
 ...
 */
export function setAllPlayerBits(): any {
 ...
 */
export function setPlayerBitAtIndex(bitIndex: number): any {
 ...
 */
export function triggerScriptEvent2(eventDataSize: number, scriptMetadataIndex: number, threadId: number): any {
