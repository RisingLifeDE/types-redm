 ...
 */
export function abort(animScene: any): void {
 ...
 */
export function attachToEntity(animScene: any, entity: number | IEntity): void {
 ...
 */
export function attachToEntityPreservingLocation(animScene: any, entity: number | IEntity): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function blockFadingNextFrame(): void {
 ...
 */
export function checkOwnershipOf(animScene: any): boolean {
 ...
 */
export function couldEntityReachExitNextFrame(animScene: any): [boolean, string] {
 ...
 */
export function detach(animScene: any): void {
 ...
 */
export function detachPreservingLocation(animScene: any): void {
 ...
 */
export function doesExist(animScene: any): boolean {
 ...
 */
export function fadeAudioIn(animScene: any): void {
 ...
 */
export function fadeAudioOut(animScene: any): void {
 ...
 */
export function getBool(animScene: any): [boolean, string] {
 ...
 */
export function getCurrentActiveCameraCount(animScene: any): number {
 ...
 */
export function getEntityLocationData(animScene: any): [boolean, string, Vector3, string] {
 ...
 */
export function getFloat(animScene: any): [number, string] {
 ...
 */
export function getInt(animScene: any): [number, string] {
 ...
 */
export function getOrigin(animScene: any, order: number): [Vector3, Vector3] {
 ...
 */
export function getPhase(animScene: any): number {
 ...
 */
export function hasExited(animScene: any): boolean {
 ...
 */
export function hasEntityExited(animScene: any): [boolean, string] {
 ...
 */
export function isExitingThisFrame(animScene: any): boolean {
 ...
 */
export function isFinished(animScene: any): boolean {
 ...
 */
export function isInSection(animScene: any): [boolean, string] {
 ...
 */
export function isLoaded(animScene: any): boolean {
 ...
 */
export function isMetadataLoaded(animScene: any): boolean {
 ...
 */
export function isRunning(animScene: any): boolean {
 ...
 */
export function isEntityExitingThisFrame(animScene: any): [boolean, string] {
 ...
 */
export function isEntityPlaying(entity: number | IEntity, animScene: any): boolean {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function load(animScene: any): void {
 ...
 */
export function removeEntity(animScene: any, entity: number | IEntity): string {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function requestPlayList(animScene: any): [boolean, string] {
 ...
 */
export function reset(animScene: any): string {
 ...
 */
export function resumeFromLastCheckpoint(animScene: any): void {
 ...
 */
export function setBool(animScene: any, value: boolean): string {
 ...
 */
export function setEntity(animScene: any, entity: number | IEntity, flags: number): string {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setFloat(animScene: any, value: number): string {
 ...
 */
export function setInt(animScene: any, value: number): string {
 ...
 */
export function setOrigin(animScene: any, pos: Vector3, rot: Vector3, order: number): void {
 ...
 */
export function setPaused(animScene: any, toggle: boolean): void {
 ...
 */
export function setPlaybackList(animScene: any): string {
 ...
 */
export function setPlayList(animScene: any): string {
 ...
 */
export function setRate(animScene: any, rate: number): void {
 ...
 */
export function start(animScene: any): void {
 ...
 */
export function takeOwnershipOf(animScene: any): void {
 ...
 */
export function triggerSkip(animScene: any): void {
 ...
 */
export function wasSkipped(animScene: any): boolean {
 ...
 */
export function _0x1407F5115FB9583E(animScene: any): boolean {
 ...
 */
export function _0x1AD896BF43619551(): void {
 ...
 */
export function _0x1C5D33A4293E6DDE(animScene: any, phaseName: string): boolean {
 ...
 */
export function _0x2DB524750DC41ED4(): boolean {
 ...
 */
export function _0x3641FCD53E59B335(mgmHandle: number, ped: number | IPed, secondaryVoiceString: string): void {
 ...
 */
export function _0x3B393716C3FD8237(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x4B85B3CF91972222(animScene: any): boolean {
 ...
 */
export function _0x5D7BFDA2290B4E39(): [boolean, string] {
 ...
 */
export function _0x61B2AAEF645DDAF0(mgmEventHandle: number, seatId: number): boolean {
 ...
 */
export function _0x73616E64696C132E(animScene: any): boolean {
 ...
 */
export function _0x9AAE3C1148A09BCA(animScene: any): boolean {
 ...
 */
export function _0xA96619FE85159ED2(animScene: any): boolean {
 ...
 */
export function _0xAE6DE22DE0ED4554(mgmHandle: number, ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xB1A196BAFE650402(mgmHandle: number, ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xC1193521E3B9FADD(entity: number | IEntity): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0xCDCD7B2D49AEE73A(): void {
 ...
 */
export function _0xD70C7A30412F8FA0(animScene: any): boolean {
 ...
 */
export function _0xE12D7B4B959644CD(): void {
 ...
 */
export function _0xEA41D44A8D42057B(): boolean {
 ...
 */
export function clearWasSkipped(animScene: any): void {
 ...
 */
export function clearBreakoutArchetype(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function create(flags: number): [any, string, string] {
 ...
 */
export function createMgmSystem(): [number, string] {
 ...
 */
export function deleteAnimScene(animScene: any): void {
 ...
 */
export function doesOwnershipOfEntityExist(animScene: any): [boolean, string] {
 ...
 */
export function doesPlayListExist(animScene: any): [boolean, string] {
 ...
 */
export function doesEntityWithIdExistIn(animScene: any): [boolean, string] {
 ...
 */
export function getDict(animScene: any): number {
 ...
 */
export function getDuration(animScene: any): number {
 ...
 */
export function getObject(animScene: any, isNetwork: boolean): [number, string] {
 ...
 */
export function getPed(animScene: any, isNetwork: boolean): [number, string] {
 ...
 */
export function getPlaybackListPhaseAudioLoadStress(animScene: any): [number, string] {
 ...
 */
export function getRate(animScene: any): number {
 ...
 */
export function getTime(animScene: any): number {
 ...
 */
export function getVehicle(animScene: any, isNetwork: boolean): [number, string] {
 ...
 */
export function hasEntityEntered(animScene: any): [boolean, string] {
 ...
 */
export function isAborted(animScene: any): boolean {
 ...
 */
export function isLoading(animScene: any): boolean {
 ...
 */
export function isMetadataAssetInRangeLoading(animScene: any): boolean {
 ...
 */
export function isPaused(animScene: any): boolean {
 ...
 */
export function isPlaybackListPhaseActive(animScene: any): [boolean, string] {
 ...
 */
export function isPlaybackListPhaseLoaded(animScene: any): [boolean, string] {
 ...
 */
export function isPlaybackListPhaseLoading(animScene: any): [boolean, string] {
 ...
 */
export function isSkippable(animScene: any): boolean {
 ...
 */
export function isMgmSystemLoaded(): [boolean, string] {
 ...
 */
export function loadMgmAssets(): [boolean, string] {
 ...
 */
export function releasePlayList(animScene: any): [boolean, string] {
 ...
 */
export function setBreakoutArchetype(ped: number | IPed): string {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setMgmEvent(mgmEventHandle: number, seatId: any): string {
