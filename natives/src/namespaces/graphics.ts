 ...
 */
export function addDecal(): number {
 ...
 */
export function addVegModifierSphere(pos: Vector3, radius: number, modType: number, flags: number): number {
 ...
 */
export function allowPickupLightSync(pickupObject: number | IObject, allow: boolean): void {
 ...
 */
export function animpostfxHasEventTriggeredByStackhash(effectNameHash: number | string, eventType: number, peekOnly: boolean): [boolean, boolean] {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
    return AnimpostfxHasEventTriggeredByStackhash(effectNameHash, eventType, peekOnly);
}
 ...
 */
export function animpostfxIsPreloadingByStackhash(effectNameHash: number | string): boolean {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function blockPickupPlacementLight(pickup: any, toggle: boolean): void {
 ...
 */
export function createCheckpointWithNamehash(typeHash: number | string, posX1: number, posY1: number, posZ1: number, posX2: number, posY2: number, posZ2: number, radius: number, red: number, green: number, blue: number, alpha: number, reserved: number): number {
 ...
 */
export function drawLowQualityPhotoToPhone(photoRotation: number): void {
 ...
 */
export function drawMarker(_type: number | string, pos: Vector3, dirX: number, dirY: number, dirZ: number, rot: Vector3, scale: Vector3, red: number, green: number, blue: number, alpha: number, bobUpAndDown: boolean, faceCamera: boolean, rotate: boolean, textureDict: string, textureName: string, drawOnEnts: boolean): void {
 ...
 */
export function drawRect(x: number, y: number, width: number, height: number, red: number, green: number, blue: number, alpha: number): void {
 ...
 */
export function queueOperationToCreateSortedListOfPhotos(): any {
 ...
 */
export function removeVegModifierSphere(vegModifierHandle: number): void {
 ...
 */
export function setGrassCullSphere(pos: Vector3): number {
 ...
 */
export function setHidofOverride(): void {
 ...
 */
export function setParticleFxAmbientColour(entity: number | IEntity, r: number, g: number, b: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setPickupLight(_object: number | IObject, toggle: boolean): void {
 ...
 */
export function startNetworkedParticleFxLoopedOnEntity(effectName: string, entity: number | IEntity, xOffset: number, yOffset: number, zOffset: number, rot: Vector3, scale: number, xAxis: boolean, yAxis: boolean, zAxis: boolean): number {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function startNetworkedParticleFxLoopedOnEntityBone(effectName: string, entity: number | IEntity, xOffset: number, yOffset: number, zOffset: number, rot: Vector3, boneIndex: number, scale: number, xAxis: boolean, yAxis: boolean, zAxis: boolean): number {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function startParticleFxNonLoopedAtCoord(effectName: string, pos: Vector3, rot: Vector3, scale: number, xAxis: number, yAxis: boolean, zAxis: boolean): boolean {
 ...
 */
export function _0x085C5B61A0114F32(): void {
 ...
 */
export function _0x0D5B19C34068FEE7(): void {
 ...
 */
export function _0x1460B644397453EB(): void {
 ...
 */
export function _0x171C18E994C1A395(): void {
 ...
 */
export function _0x1A9F09AB458D49C6(): void {
 ...
 */
export function _0x1C6306E5BC25C29C(): void {
 ...
 */
export function _0x1FF8731BE1DFC0C0(): void {
 ...
 */
export function _0x21F00E08CBB5F37B(component: string): void {
 ...
 */
export function _0x26DD2FB0A88CC412(effectName: string, effectName2: string): void {
 ...
 */
export function _0x285438C26C732F9D(): any {
 ...
 */
export function _0x32DE2BFFDA43E62A(): void {
 ...
 */
export function _0x38D9D50F2085E9B3(effectNameHash: number | string): void {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function _0x3DA7A10583A4BEC0(): boolean {
 ...
 */
export function _0x402E1A61D2587FCD(pos: Vector3, heading: number): boolean {
 ...
 */
export function _0x4046493D2EEACA0E(): void {
 ...
 */
export function _0x41F88A85A579A61D(): void {
 ...
 */
export function _0x453D16D41FC51D3E(): void {
 ...
 */
export function _0x48FE0DB54045B975(): void {
 ...
 */
export function _0x4BD66B4E3427689B(): void {
 ...
 */
export function _0x4FB67D172C4476F3(entity: number | IEntity): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0x503941F65DBA24EC(): void {
 ...
 */
export function _0x519928DF02EB5101(): void {
 ...
 */
export function _0x5AC6E0FA028369DE(): void {
 ...
 */
export function _0x5C674EB487891F6B(): any {
 ...
 */
export function _0x5C9C3A466B3296A8(): any {
 ...
 */
export function _0x67B0778C62E74423(): void {
 ...
 */
export function _0x6C03118E9E5C1A14(): void {
 ...
 */
export function _0x71845905BCCDE781(effectNameHash: number | string): void {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function _0x735762E8D7573E42(): void {
 ...
 */
export function _0x812C1563185C6FB2(): void {
 ...
 */
export function _0x815653A42C5ABE76(): void {
 ...
 */
export function _0x8996FA6AD9FE4E90(): void {
 ...
 */
export function _0x910E260AEAD855DE(): void {
 ...
 */
export function _0x94B261F1F35293E1(): void {
 ...
 */
export function _0x981C7D863980FA51(): void {
 ...
 */
export function _0x9D1B0B5066205692(): void {
 ...
 */
export function _0x9F158A49B0D84C3C(): void {
 ...
 */
export function _0x9F6D859C80708B26(): void {
 ...
 */
export function _0xA04EF43030593ABC(): void {
 ...
 */
export function _0xA0F4D12D6042F6D5(): void {
 ...
 */
export function _0xA15CCAB8AD038291(): any {
 ...
 */
export function _0xA1A86055792FB249(personaPhotoLocalCacheType: number): void {
 ...
 */
export function _0xA201A3D0AC087C37(effectName: string): void {
 ...
 */
export function _0xA21AF60C9F99CCC5(): void {
 ...
 */
export function _0xB032C085D9A03907(): void {
 ...
 */
export function _0xB958D97A0DFAA0C2(effectName: string): boolean {
 ...
 */
export function _0xC06F2F45A73EABCD(entity: number | IEntity): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0xC28F62AC9774FC1B(): any {
 ...
 */
export function _0xC37792A3F9C90771(): any {
 ...
 */
export function _0xC489FE31AC726512(): void {
 ...
 */
export function _0xC76FC4C2FC5F4405(effectNameHash: number | string): void {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function _0xCC3B787E73E64160(): void {
 ...
 */
export function _0xD1472AFF30C103D6(): void {
 ...
 */
export function _0xD543487A1F12828F(): void {
 ...
 */
export function _0xD9BC98B55BCFAA9B(): void {
 ...
 */
export function _0xE63D68F455CA0B47(): any {
 ...
 */
export function _0xE75CDDEBF618C8FF(effectNameHash: number | string): boolean {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function _0xEB48CE48EEC41FD4(): void {
 ...
 */
export function _0xEC3D8C228FE553D7(): boolean {
 ...
 */
export function _0xEC3F7F24EEEB3BA3(): void {
 ...
 */
export function _0xF2F543D48F319A3A(): void {
 ...
 */
export function _0xF5793BB386E1FF9C(): void {
 ...
 */
export function _0xFB680A9B33D0EDBE(): void {
 ...
 */
export function _0xFBF161FCFEC8589E(effectName: string): [boolean, boolean] {
 ...
 */
export function _0xFC9B53C072F418E0(): any {
 ...
 */
export function _0xFD05B1DDE83749FA(): boolean {
 ...
 */
export function _0xFF584F097C17FA8F(): boolean {
 ...
 */
export function _0xFF8018C778349234(): void {
 ...
 */
export function addBloodPool(pos: Vector3, unused: boolean): void {
 ...
 */
export function addBloodPoolsForPed(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function addBloodPoolsForPedWithParams(ped: number | IPed, size: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function addBloodPool2(pos: Vector3, size: number, permanent: boolean): void {
 ...
 */
export function addBloodTrailPoint(pos: Vector3): void {
 ...
 */
export function addBloodTrailSplat(pos: Vector3): void {
 ...
 */
export function addEntityToEntityMask(entity: number | IEntity, mask: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function addEntityToEntityMaskWithIntensity(entity: number | IEntity, mask: number, intensity: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function addVegModifierZone(volume: number, flags: number): number {
 ...
 */
export function animpostfxIsStackhashPlaying(effectNameHash: number | string): boolean {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function animpostfxPlayTag(effectNameHash: number | string): void {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function animpostfxPreloadPostfxByStackhash(effectNameHash: number | string): void {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function animpostfxSetPostfxColor(effectName: string, red: number, green: number, blue: number, alpha: number): void {
 ...
 */
export function animpostfxSetPotency(effectName: string, potency: number): void {
 ...
 */
export function animpostfxStopStackhashPostfx(effectNameHash: number | string): void {
    if (typeof effectNameHash === 'string') effectNameHash = GetHashKey(effectNameHash)
 ...
 */
export function blockPickupObjectLight(pickupObject: number | IObject, toggle: boolean): void {
    const _pickupObject = pickupObject instanceof IObject ? pickupObject.handle() : pickupObject;
 ...
 */
export function bloodTrailForWaypoint(waypointRecording: string): void {
 ...
 */
export function disableStaticVegModifier(p0: number | string): void {
 ...
 */
export function enableStaticVegModifier(p0: number | string): void {
    if (typeof p0 === 'string') p0 = GetHashKey(p0)
 ...
 */
export function generateSwatchTexture(slotId: number, componentHash: number | string, metapedType: number): void {
 ...
 */
export function generateSwatchTextureDirectly(slot: number): void {
 ...
 */
export function getEntityMaskLayers(entity: number | IEntity): [boolean, number, number, number, number] {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isStaticVegModifierEnabled(p0: number | string): boolean {
    if (typeof p0 === 'string') p0 = GetHashKey(p0)
 ...
 */
export function isTextureInDict(txdHash: number | string, dict: number | string): boolean {
    if (typeof txdHash === 'string') txdHash = GetHashKey(txdHash)
    if (typeof dict === 'string') dict = GetHashKey(dict)
 ...
 */
export function pedshotGeneratePersonaPhoto(texture: string, ped: number | IPed, playerSlot: number): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function removeEntityFromEntityMask(entity: number | IEntity): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCloudLayer(x: number, y: number): void {
    SetCloudLayer(x, y, 0);
}
 ...
 */
export function setCloudNoise(pos: Vector3): void {
 ...
 */
export function setCloudPosition(pos: Vector3): void {
 ...
 */
export function setDistrictPhotoTakenStat(): void {
 ...
 */
export function setEntityAura(): void {
    SetEntityAura(0, 0, 0);
}
 ...
 */
export function setEntityMaskLayers(entity: number | IEntity): [number, number, number, number] {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setEntityRenderGuarmaShip(vehicle: number | IVehicle, toggle: boolean): void {
 ...
 */
export function setLightsColorForEntity(entity: number | IEntity, red: number, green: number, blue: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setLightsIntensityForEntity(entity: number | IEntity, intensity: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setLightsTypeForEntity(entity: number | IEntity, _type: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setParticleFxNonLoopedEmitterScale(): void {
 ...
 */
export function setPearlescentFxEnabled(_object: number | IObject, toggle: boolean): void {
    const __object = _object instanceof IObject ? _object.handle() : _object;
 ...
 */
export function setPhotoInPhotomodeStat(): void {
 ...
 */
export function setPhotoModeExposureLocked(lock: boolean): void {
 ...
 */
export function setPhotoOverlayEffectStat(): void {
 ...
 */
export function setPhotoSelfStat(): void {
 ...
 */
export function setPhotoStudioStat(): void {
 ...
 */
export function setPlayerAppearInPhoto(player: number | string | IPlayer): void {
 ...
 */
export function setRegionPhotoTakenStat(): void {
 ...
 */
export function setSnowCoverageType(_type: number): void {
 ...
 */
export function setStatePhotoTakenStat(): void {
 ...
 */
export function startParticleFxNonLoopedOnPedBone2(effectName: string, ped: number | IPed, offsetX: number, offsetY: number, offsetZ: number, rot: Vector3, boneIndex: number, scale: number, axisX: boolean, axisY: boolean, axisZ: boolean): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
