 ...
 */
export function applyForceToCenterOfMass(entity, forceType, pos, component, isDirectionRel, isForceRel) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function attachToEntityPhysically(entity1, entity2, boneIndex, offsetX, offsetY, offsetZ) {
    const _entity1 = entity1 instanceof IEntity ? entity1.handle() : entity1;
    const _entity2 = entity2 instanceof IEntity ? entity2.handle() : entity2;
 ...
 */
export function createModelHide(pos, radius, model) {
 ...
 */
export function createModelHideExcludingScriptObjects(pos, radius, model) {
    if (typeof model === 'string')
        model = GetHashKey(model);
 ...
 */
export function detach(entity, collision) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getCarriableState(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getCoords(entity, alive, realCoords) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getMatchingEntities(volume, itemSet, entityType, p4) {
    if (typeof p4 === 'string')
        p4 = GetHashKey(p4);
 ...
 */
export function getNearestPlayerTo(entity, playerPedToIgnore, flags) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getNearestPlayerToOnTeam(entity, team, playerPedToIgnore, flags) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    const _playerPedToIgnore = playerPedToIgnore instanceof IPed ? playerPedToIgnore.handle() : playerPedToIgnore;
 ...
 */
export function hasClearLosToCoord(entity, pos, flags) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function hasClearLosToEntityInFront(entity1, entity2, traceType) {
    const _entity1 = entity1 instanceof IEntity ? entity1.handle() : entity1;
    const _entity2 = entity2 instanceof IEntity ? entity2.handle() : entity2;
 ...
 */
export function isInAngledArea(entity, originX, originY, originZ, edgeX, edgeY, edgeZ, angle) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isInVolume(entity, volume) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isPlayingAnim(entity, animType) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function pinClosestMap(modelHash, pos, flags) {
    if (typeof modelHash === 'string')
        modelHash = GetHashKey(modelHash);
 ...
 */
export function placeOnGroundProperly(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function playAnim(entity, loop, stayInAnim, delta, bitset) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function removeForcedObject() {
 ...
 */
export function removeModelHide() {
 ...
 */
export function scriptOverrideLootTablePermanent(entity, lootTable) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof lootTable === 'string')
        lootTable = GetHashKey(lootTable);
 ...
 */
export function setAsMissionEntity(entity, scriptHostObject, grabFromOtherScript) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCanOnlyBeDamagedByScriptParticipants(EntityIndex, bOnlyDamagedWhenRunningScript) {
 ...
 */
export function setHealth(entity, healthAmount, entityKilledBy) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setInvincible(entity, toggle) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setNoweapondecals(entity, toggle) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setOnlyDamagedByRelationshipGroup(entity, relationshipGroup) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setProofs(entity, proofsBitset, specialFlag) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0x002AAC783ED323ED() {
 ...
 */
export function _0x007AAC783ED323ED() {
 ...
 */
export function _0x0CCEFC6C2C95DA2A() {
 ...
 */
export function _0x0DB41D59E0F1502B() {
 ...
 */
export function _0x0FD7D7C232876E72() {
 ...
 */
export function _0x16908E859C3AB698() {
 ...
 */
export function _0x188736456D1DEDE6() {
 ...
 */
export function _0x2A77EF9BEC8518F4() {
 ...
 */
export function _0x2D40BCBFE9305DEA() {
 ...
 */
export function _0x350E9211074955AF() {
 ...
 */
export function _0x37CEB637BA3B1A47() {
 ...
 */
export function _0x383F64263F946E45(entity, ped) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0x3AB3A77672F6473F() {
 ...
 */
export function _0x3EC28DA1FFAC9DDD(entity1, entity2) {
    const _entity1 = entity1 instanceof IEntity ? entity1.handle() : entity1;
    const _entity2 = entity2 instanceof IEntity ? entity2.handle() : entity2;
 ...
 */
export function _0x3F08C6163A4AB1D6() {
 ...
 */
export function _0x56E0735D6273B227() {
 ...
 */
export function _0x582F73ACFE969571() {
 ...
 */
export function _0x6C31B06E91518269() {
 ...
 */
export function _0x7A49D40DE437BC8D() {
 ...
 */
export function _0x7F20092547B4DDEA() {
 ...
 */
export function _0x80FDEB3A9E9AA578(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0x8E10DF0FFA63FB65() {
 ...
 */
export function _0x978AA2323ED32209() {
 ...
 */
export function _0xA48E4801DEBDF7E4(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0xA9E6D8F2DDFC4DB9() {
 ...
 */
export function _0xAAACB74442C1BED3() {
 ...
 */
export function _0xAF7F3099B9FEB535(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0xB16C780C51E51E2B() {
 ...
 */
export function _0xB38A29CCD5447783() {
 ...
 */
export function _0xBA2A089E60ED1163() {
 ...
 */
export function _0xBD94CECFB2D65119() {
 ...
 */
export function _0xC0EDEF16D90661EE(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0xC2E71D7E0A7B4C89() {
 ...
 */
export function _0xC3ABCFBC7D74AFA5(ped) {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xC6A1A3D63F122DE7() {
 ...
 */
export function _0xC76E94A78127412B() {
 ...
 */
export function _0xD21C7418C590BB40() {
 ...
 */
export function _0xD45BB89B53FC0CFD() {
 ...
 */
export function _0xD4636C2EDB0DEA8A() {
 ...
 */
export function _0xD46BF94C4C66FAB0() {
 ...
 */
export function _0xDF8E49EA89A01DB1() {
 ...
 */
export function _0xDFC2B226D56D85F6() {
 ...
 */
export function _0xE19035EB65AB2932() {
 ...
 */
export function _0xE31FC20319874CB3() {
 ...
 */
export function _0xE75EEA8DB59A9F39() {
 ...
 */
export function _0xE9E7A0BAC7F57746() {
 ...
 */
export function _0xEAB3D91D30A344F1() {
 ...
 */
export function _0xEF259AA1E097E0AD(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function _0xF41E2979D5BC5370() {
 ...
 */
export function _0xF59FDE7B4D31A630() {
 ...
 */
export function addTrackingTrails(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function attachToCoordsPhysically(entity, pos, offsetx, offsety, offsetz, timer) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function changeHealth(entity, amount, entity2, weaponHash) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    const _entity2 = entity2 instanceof IEntity ? entity2.handle() : entity2;
 ...
 */
export function createFootpathTrail(waypointRecord, bUseSnowOffset, bInit) {
 ...
 */
export function deleteCarriable() {
 ...
 */
export function doesThreadOwnThis(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function forceTrainWagonPopulation(carriage, force) {
 ...
 */
export function getCarriableFrom(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getEntitiesNearPoint(pos, radius, itemSet) {
 ...
 */
export function getAnimCurrentTime(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getByDoorhash(doorHash) {
 ...
 */
export function getCarryingFlag(entity, flagId) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getCarryConfig(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getForwardVectorYx(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getHealthFloat(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getLootingPed(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getThreatTier(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getWorldPositionOfDimensions(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getOffsetFromBone(entity, boneIndex) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getPeltTexture(albedoHash, txdAlbedoDV, txdNormalMapDV, txdMaterialDV) {
 ...
 */
export function getPeltTextureByCarriable(carriableHash) {
    if (typeof carriableHash === 'string')
        carriableHash = GetHashKey(carriableHash);
 ...
 */
export function getScriptOverrideLootTablePermanent(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isFullyLooted(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isOnTrainTrack(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isOwnedByPersistenceSystem(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isPlayingAnyAnim(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isUnderwater(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isTrackedVisible(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function pauseTracking(entity, pause) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function requestLootList(mount, visiblelootslotrequestType, flag) {
    const _mount = mount instanceof IPed ? mount.handle() : mount;
    if (typeof visiblelootslotrequestType === 'string')
        visiblelootslotrequestType = GetHashKey(visiblelootslotrequestType);
 ...
 */
export function searchBuildingPoolForWithThisModel(modelHash) {
    if (typeof modelHash === 'string')
        modelHash = GetHashKey(modelHash);
 ...
 */
export function setAnimCurrentTime(entity, time) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setAnimSpeed(entity, speedMultiplier) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCarcassType(entity, _type) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCarryingFlag(entity, flagId, value) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCoordsAndHeading(entity, pos, heading, xAxis, yAxis, zAxis) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCoordsAndHeadingNoOffset(entity, pos, heading) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setCustomPickupRadius(entity, radius) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setFadeIn(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setFullyLooted(entity, looted) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setLightsEnabled(entity, enabled) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setThreatTier(entity, tier) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setMaterialFillLevelFor(entity, expressionType, fillState) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setPeltTexture(_object, inventoryItem, albedo) {
 ...
 */
export function unpinMap(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
