 ...
 */
export declare function forceDespawn(persChar: any): void;
/**
 * No comment provided
 *
 * Hash: 0x0CADC3A977997472 | Since: 1207
 */
export declare function forceSpawn(persChar: any): number;
/**
 * No comment provided
 *
 * Hash: 0x32A1E3B83D501096 | Since: 1207
 */
export declare function getIndexFromPedIndex(ped: number | IPed): any;
/**
 * No comment provided
 *
 * Hash: 0xA00DF706C60173D1 | Since: 1207
 */
export declare function getModelName(persCharHash: number | string): number;
/**
 * No comment provided
 *
 * Hash: 0xDC9655D47DEC0353 | Since: 1207
 */
export declare function getOutfit(persCharHash: number | string): number;
/**
 * No comment provided
 *
 * Hash: 0x31C70A716CAE1FEE | Since: 1207
 */
export declare function getPedIndex(persChar: any): number;
/**
 * No comment provided
 *
 ...
 */
export declare function resetSchedule(persCharHash: number | string): void;
/**
 * No comment provided
 *
 ...
 */
export declare function revive(persChar: any): boolean;
/**
 * No comment provided
 *
 * Hash: 0x2DF89CD2ED1D0BDE | Since: 1207
 */
export declare function setOutfit(persCharHash: number | string, outfit: number | string): void;
/**
 * No comment provided
 *
 * Hash: 0x187D65F3AEC5D679 | Since: 1207
 */
export declare function setSchedule(persCharHash: number | string): string;
