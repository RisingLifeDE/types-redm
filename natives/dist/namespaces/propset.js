import { IEntity, IVehicle } from '@risinglife/redm-shared';
/**
 * No comment provided
 *
 * Hash: 0x9609DBDDE18FAD8C | Since: 1207
 */
export function createInstanceAttachedToEntity(hash, pos, entity) {
 ...
 */
export function doesExist(propSet) {
 ...
 */
export function isFullyLoaded(propSet) {
 ...
 */
export function _0x58E0B01D45CA7357() {
 ...
 */
export function addLightToVehicle(vehicle, lightPropset) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
    if (typeof lightPropset === 'string')
        lightPropset = GetHashKey(lightPropset);
 ...
 */
export function addForVehicle(vehicle, propset) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
    if (typeof propset === 'string')
        propset = GetHashKey(propset);
 ...
 */
export function create(propsetType, pos, placementType, heading, zProbe, useVegMod) {
    if (typeof propsetType === 'string')
        propsetType = GetHashKey(propsetType);
 ...
 */
export function create2(propsetType, pos, placementType, heading, zProbe, useVegMod) {
    if (typeof propsetType === 'string')
        propsetType = GetHashKey(propsetType);
 ...
 */
export function createInstanceAttachedToEntity2(hash, pos, entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof hash === 'string')
        hash = GetHashKey(hash);
 ...
 */
export function deletePropSet(propSet) {
 ...
 */
export function doesOfTypeExistNearCoords(propsetHash, pos) {
    if (typeof propsetHash === 'string')
        propsetHash = GetHashKey(propsetHash);
 ...
 */
export function doesVehicleHaveAnyLight(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function doesVehicleHaveAny(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function getEntitiesFrom(propSet, itemSet, model) {
 ...
 */
export function getAtCoords(propsetHash, pos) {
    if (typeof propsetHash === 'string')
        propsetHash = GetHashKey(propsetHash);
 ...
 */
export function getModel(propSet) {
 ...
 */
export function getTrainCarriage(trainCarriage) {
 ...
 */
export function getVehicleLight(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function getVehicleHash(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function hasLoaded(hash) {
    if (typeof hash === 'string')
        hash = GetHashKey(hash);
 ...
 */
export function hasLoaded2(hash) {
    if (typeof hash === 'string')
        hash = GetHashKey(hash);
 ...
 */
export function hasVehicleTrailerLoaded(vehicle, wagonIndex) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function isVisible(propSet) {
 ...
 */
export function isVehicleLightLoaded(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function isVehicleLoaded(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function isVehicleLoadedAdditional(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function moveCoordsAndHeading(propset, pos, onGroundProperly, heading) {
 ...
 */
export function removeVehicleLights(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function removeVehicles(vehicle) {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function setAsNoLongerNeeded(propSet) {
 ...
 */
export function setFlag(propSet, flag) {
 ...
 */
export function setVisible(propSet, toggle) {
