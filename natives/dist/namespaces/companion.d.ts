 ...
 */
export declare function _0x0DE02DA3C0F66955(ped: number | IPed, p1: number | string): void;
/**
 * No comment provided
 *
 * Hash: 0x2917E634206B9E17 | Since: 1207
 */
export declare function _0x2917E634206B9E17(ped: number | IPed): void;
/**
 * No comment provided
 *
 ...
 */
export declare function _0xD428C3F92FC3F6F8(ped: number | IPed): void;
/**
 * No comment provided
 *
 ...
 */
export declare function _0xD730281E496621FB(ped: number | IPed, p1: number | string): void;
/**
 * No comment provided
 *
 ...
 */
export declare function activateAnalysis(groupId: number): void;
/**
 * Used for Script Function NET_FETCH_CLIENT_ACTIVATE_COMAPNION_ANALYSIS: Hiding! Ped
 *
 * Hash: 0xDEB369F6AD168C58 | Since: 1207
 */
export declare function addFlag(ped: number | IPed): void;
/**
 * No comment provided
 *
 * Hash: 0x72B7F65F11FC8896 | Since: 1207
 */
export declare function deactivateAnalysis(groupId: number): void;
/**
 * enum _0x18F77396
 *
 * Hash: 0xB7E0590C86E1711F | Since: 1207
 */
export declare function getActivity(groupId: number): number;
/**
 * No comment provided
 *
 * Hash: 0x1740E3DEE0AE4D27 | Since: 1207
 */
export declare function removeFlag(ped: number | IPed): void;
/**
 * enum _0x18F77396
 *
 * Hash: 0x0F1CD8CA9E65D5F6 | Since: 1207
 */
export declare function setActivity(groupId: number, activity: number | string): void;
