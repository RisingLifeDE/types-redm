 ...
 */
export declare function getIsThreatIndicatorCapableRadarShown(): boolean;
/**
 * No comment provided
 *
 * Hash: 0xFC2E0A5E9ED4E1B4 | Since: 1207
 */
export declare function getIsThreatIndicatorOn(): boolean;
/**
 * enum eRpgIcons
 * {
 * ICON_STAMINA,
 ...
 */
export declare function setRpgIconVisibility(rpgIcon: number, visibility: number): void;
