 ...
 */
export function reactivateNamedObjectsWaitingTillOutOfRange() {
 ...
 */
export function registerObjectScript(modelHash, activationRange) {
 ...
 */
export function getScriptEntity() {
 ...
 */
export function removeScriptEntity(entity) {
 ...
 */
export function startPreloadedScript(entity, scriptStackSize) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function startScript(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
