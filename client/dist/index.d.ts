 ...
 */
export declare function getEntityIndexFromMapdata(mapdata: number, entity1: number): number;
/**
 * Retrieves the map data and entity handles from a specific entity.
 * This function supports SDK infrastructure and is not intended to be used directly from your code.
 *
 ...
 */
export declare function getPedModelHealthConfig(modelHash: number | string): number;
/**
 * Gets a ped model's personality type.
 *
 * Hash: 0xFE08CAD6
 ...
 */
export declare function setPedModelHealthConfig(modelHash: number | string, configName: string): void;
/**
 * Overrides a ped model personality type.
 *
 * Hash: 0x46F6B38B
 ...
 */
export declare function getTrackBrakingDistance(track1: number): number;
/**
 * No comment provided
 *
 * Hash: 0x34EE2BF3
 ...
 */
export declare function getTrackMaxSpeed(track1: number): number;
/**
 * Gets the coordinates of a specific track node.
 *
 * Hash: 0x1628548E
 ...
 */
export declare function isTrackEnabled(track1: number): boolean;
/**
 * Getter for [SWITCH_TRAIN_TRACK](#\_0xFD813BB7DB977F20). Determines if ambient trains are able to spawn on this track.
 *
 * Hash: 0xE0C53765
 ...
 */
export declare function isTrackSwitchedOff(track1: number): boolean;
/**
 * Registers a track junction that when enabled will cause a train on the defined trackIndex, node and direction to change its current track index and begin traveling on the new node
 *
 * Hash: 0x35F743B5
 ...
 */
export declare function setTrackBrakingDistance(track1: number, brakingDistance: number): void;
/**
 * Toggles the track being active. If disabled mission trains will not be able to spawn on this track and will look for the next closest track to spawn
 *
 * Hash: 0x4B41E84C
 ...
 */
export declare function setTrackEnabled(track1: number, enabled: boolean): void;
/**
 * Sets the state of a track junction.
 *
 * Hash: 0x537B449D
 ...
 */
export declare function setTrackMaxSpeed(track1: number, newSpeed: number): void;
/**
 * Break off vehicle wheel by index. The `leaveDebrisTrail` flag requires `putOnFire` to be true.
 *
 * Hash: 0xA274CADB
 ...
 */
export declare function setHandlingField(vehicle1: string, class_: string, fieldName: string, value: any): void;
/**
 * Sets a global handling override for a specific vehicle class. The name is supposed to match the `handlingName` field from handling.meta.
 * Example: `SetHandlingFloat('AIRTUG', 'CHandlingData', 'fSteeringLock', 360.0)`
 *
 ...
 */
export declare function setHandlingFloat(vehicle1: string, class_: string, fieldName: string, value: number): void;
/**
 * Sets a global handling override for a specific vehicle class. The name is supposed to match the `handlingName` field from handling.meta.
 *
 * Hash: 0x8AB3F46C
 ...
 */
export declare function setHandlingInt(vehicle1: string, class_: string, fieldName: string, value: number): void;
/**
 * Sets a global handling override for a specific vehicle class. The name is supposed to match the `handlingName` field from handling.meta.
 * Example: `SetHandlingVector('AIRTUG', 'CHandlingData', 'vecCentreOfMassOffset', vector3(0.0, 0.0, -5.0))`
 *
 ...
 */
export declare function setHandlingVector(vehicle1: string, class_: string, fieldName: string, value: Vector3): void;
/**
 * This completely disables pedestrian vehicles from reacting to sirens. They will not try to do any maneuver to evade.
 *
 * Hash: 0xB90BBC6E
