 ...
 */
export function drawGlowSphere(posX, posY, posZ, radius, colorR, colorG, colorB, intensity, invert, marker) {
    DrawGlowSphere(posX, posY, posZ, radius, colorR, colorG, colorB, intensity, invert, marker);
}
/**
 ...
 */
export function drawCorona(posX, posY, posZ, size, red, green, blue, alpha, intensity, zBias, dirX, dirY, dirZ, viewThreshold, innerAngle, outerAngle, flags) {
    DrawCorona(posX, posY, posZ, size, red, green, blue, alpha, intensity, zBias, dirX, dirY, dirZ, viewThreshold, innerAngle, outerAngle, flags);
}
/**
...
export function getCamMatrix(camera) {
    const result = GetCamMatrix(camera);
...
export function getPedBoneMatrix(ped, boneId) {
    const _ped = ped instanceof Ped ? ped.handle() : ped;
    const result = GetPedBoneMatrix(_ped, boneId);
    return [result[0], new Vector3(result[1], result[2], result[3]), new Vector3(result[2], result[3], result[4]), new Vector3(result[3], result[4], result[5]), new Vector3(result[4], result[5], result[6])];
}
/**
...
export function getTrackNodeCoords(trackIndex, trackNode) {
    const result = GetTrackNodeCoords(trackIndex, trackNode);
 ...
 */
export function getWaterQuadAtCoords3d(position) {
    return GetWaterQuadAtCoords3d(position.x, position.y, position.z);
}
/**
 ...
 */
export function getWorldCoordFromScreenCoord(screenX, screenY) {
    const result = GetWorldCoordFromScreenCoord(screenX, screenY);
 ...
 */
export function setDrawOrigin(position, is2d) {
    SetDrawOrigin(position.x, position.y, position.z, is2d);
}
/**
 ...
 */
export function setInteriorPortalCornerPosition(interiorId, portalIndex, cornerIndex, posX, posY, posZ) {
    SetInteriorPortalCornerPosition(interiorId, portalIndex, cornerIndex, posX, posY, posZ);
}
/**
