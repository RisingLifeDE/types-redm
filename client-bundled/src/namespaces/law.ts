 ...
 */
export function addBounty(player: number | string | IPlayer, itemValueAmount: number): void {
 ...
 */
export function areWitnessesActive(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function clearBounty(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    ClearBounty(_player);
}
 ...
 */
export function clearPlayerPastCrimes(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function clearWantedScore(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getBounty(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getPlayerRegisteredCrime(player: number | string | IPlayer, index: number): [boolean, any] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getWantedScore(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isIncidentActive(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function numCrimesSuppressed(player: number | string | IPlayer, crimeType: number | string): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function resetWantedForNewIncident(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setBounty(player: number | string | IPlayer, amount: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDisableDisturbanceCrimes(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSenseRangeModifier(player: number | string | IPlayer, range: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setPlayerArrestedInRegion(player: number | string | IPlayer, lawRegionHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof lawRegionHash === 'string') lawRegionHash = GetHashKey(lawRegionHash)
 ...
 */
export function setPlayerTurnedInBountyInRegion(player: number | string | IPlayer, lawRegionHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof lawRegionHash === 'string') lawRegionHash = GetHashKey(lawRegionHash)
 ...
 */
export function setPostponeDisturbanceCrimesDuringCombat(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setWantedScore(player: number | string | IPlayer, intensity: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function suppressCrimeThisFrame(player: number | string | IPlayer, crimeType: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0x00DB0BC05E3FAA4E(ped: number | IPed, bitset: number): void {
 ...
 */
export function _0x018F30D762E62DF8(ped: number | IPed): [any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x07E8B8B20570271C(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x0BDFEBCF40A5F7E3(crimeType: number | string): number {
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0x0C392DB374655176(pos: Vector3, itemSet: any): void {
 ...
 */
export function _0x0DBACA9C38C9A686(name: string): boolean {
 ...
 */
export function _0x0EAF918F751F27BA(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x0F230DE0DDBE3649(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x15ABD5004CAD2D99(): void {
 ...
 */
export function _0x2001687F9562FD9D(): void {
 ...
 */
export function _0x21213B833EF4DAE7(player: number | string | IPlayer, ped: number | IPed): Vector3 {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x22741652985C84D0(player: number | string | IPlayer, lawRegionHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof lawRegionHash === 'string') lawRegionHash = GetHashKey(lawRegionHash)
 ...
 */
export function _0x26934083D3F2579C(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x292AD61A33A7A485(): void {
 ...
 */
export function _0x29CD4896ECB66C12(): void {
 ...
 */
export function _0x318F0F9A4426CFA2(ped: number | IPed): [any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x331D349E0380B097(): void {
 ...
 */
export function _0x3738B784DDD35CC6(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x3852237A3D9DF145(): void {
 ...
 */
export function _0x390710D2DAFA6BFF(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x3D2674828A4E6B3C(): boolean {
 ...
 */
export function _0x40851BCC33ACD9AB(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x522F74636DF10201(player: number | string | IPlayer, itemSet: any): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x5E6F375CA101C108(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x61B98367D93F012F(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x6ABC50979655BEE7(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x7351DA734F989F4E(entity: number | IEntity): boolean {
 ...
 */
export function _0x7803436E68C32B26(): void {
 ...
 */
export function _0x7EF2A2FE38D74456(flag: number): void {
 ...
 */
export function _0x7FC667F6DDFBCDCC(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x82F11E1296996574(): void {
 ...
 */
export function _0x856CE8FDE2416602(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x89E005B1662F6E48(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x95878B13E272EF1F(entity: number | IEntity, ped: number | IPed, pos: Vector3, crimeType: number | string): any {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0x9772395CC73E8D1F(ped: number | IPed, name: string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x987BE590FB9D41E5(): void {
 ...
 */
export function _0x9945A3E2528A02E8(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x9B4C564BFA7CFF37(): void {
 ...
 */
export function _0x9C5BD8C562565CE6(): number {
 ...
 */
export function _0x9C8A2BF37E966464(player: number | string | IPlayer, itemSet: any): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x9D5C9A5A3321B128(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x9EF07CFBB19A9733(): boolean {
 ...
 */
export function _0xB527099D1E1EED49(player: number | string | IPlayer): [boolean, number] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xBD944A3D36E992DE(): void {
 ...
 */
export function _0xC0DF161950FB101E(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xC310239ACCCF5579(): void {
 ...
 */
export function _0xC5EB2755FA25F1E9(): void {
 ...
 */
export function _0xC687A23E166DCF68(): [any, any] {
 ...
 */
export function _0xC7DC5A0A7DF608CB(flag: number): boolean {
 ...
 */
export function _0xCBFB4951F2E3934C(player: number | string | IPlayer): any {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xD6C0A8C7C0B2F82C(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xD7494DED50C6EF52(player: number | string | IPlayer, crimeType: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0xDA1A9ADC4E3D4B16(itemSet: any): void {
 ...
 */
export function _0xDAEFDFDB2AEECE37(crimeType: number | string): number {
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0xDCF12B89624AAC96(): void {
 ...
 */
export function _0xDEA083C16BB91345(): void {
 ...
 */
export function _0xE083BEDA81709891(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xE4D6E45F491A66CB(player: number | string | IPlayer): any {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xE94B5E938619712E(): void {
 ...
 */
export function _0xE9AC8466ABE484BB(): void {
 ...
 */
export function _0xE9EB79CBF9C0F58A(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xEDFC6C1FD1C964F5(player: number | string | IPlayer, crimeType: number | string, bounty: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0xF46108C50A22B029(): boolean {
 ...
 */
export function _0xF611DE44AEB36A1D(crimeType: number | string): void {
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function _0xFFEBE5AA96BC2E4E(ped: number | IPed, crimeType: number | string): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function addWitnessResponse(player: number | string | IPlayer, crimeType: number | string, pedGroup: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function areAnyPedsInvestigating(): boolean {
 ...
 */
export function areInvestigatorsActive(player: number | string | IPlayer, areInvestigatorsActive: boolean): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function arePedsEnabledForTrain(): boolean {
 ...
 */
export function areWitnessesPending(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function createGuardZoneForEntity(guardZoneName: string, entity: number | IEntity, pos: Vector3): boolean {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function createDispatchResponseForCoords(pos: Vector3, dispatchResponseHash: number | string): any {
    if (typeof dispatchResponseHash === 'string') dispatchResponseHash = GetHashKey(dispatchResponseHash)
 ...
 */
export function enableDispatch(toggle: boolean): void {
 ...
 */
export function enableDispatch2(toggle: boolean): void {
 ...
 */
export function forceOnLocalPlayerImmediately(): void {
 ...
 */
export function getBountyHunterGlobalCooldown(p0: number | string): number {
 ...
 */
export function getCrimeBountyAmountByType(crimeType: number | string): number {
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function getCrimeDispatchTypeForPlayer(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getHudPlayerCrimeType(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getTimeSinceLastSeenBy(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isGuardPedInvestigating(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function witnessResponseTask(pedGroup1: number | IPed, ped: number | IPed, pedGroup2: number | IPed, pos: Vector3, crimeType: number | string): boolean {
 ...
 */
export function pauseBountyHunterCooldown(p0: number | string): void {
    if (typeof p0 === 'string') p0 = GetHashKey(p0)
 ...
 */
export function reportCrime(player: number | string | IPlayer, crimeType: number | string, bounty: number, entity: number | IEntity, isKnownSuspect: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof crimeType === 'string') crimeType = GetHashKey(crimeType)
 ...
 */
export function reportPlayerDispatchResponseOverride(player: number | string | IPlayer, dispatchResponseHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof dispatchResponseHash === 'string') dispatchResponseHash = GetHashKey(dispatchResponseHash)
 ...
 */
export function setAllowDisabledResponses(toggle: boolean): void {
 ...
 */
export function setBountyHunterGlobalCooldown(p0: number | string): void {
    if (typeof p0 === 'string') p0 = GetHashKey(p0)
 ...
 */
export function setCantLoseThisResponse(enable: boolean): void {
 ...
 */
export function setCustomDispatchResponse(dispatchResponseHash: number | string): void {
    if (typeof dispatchResponseHash === 'string') dispatchResponseHash = GetHashKey(dispatchResponseHash)
 ...
 */
export function setGuardZonePosition(name: string, pos: Vector3): void {
 ...
 */
export function setGuardZonePosition2(name: string, pos: Vector3): void {
 ...
 */
export function setGuardZoneVolumeThreat(volume: number): string {
 ...
 */
export function setGuardZoneVolumeWarning(volume: number): string {
 ...
 */
export function setDisabled(toggle: boolean): void {
 ...
 */
export function setRbsVolume(player: number | string | IPlayer, p1: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setRegion(player: number | string | IPlayer, lawRegionHash: number | string, stateHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof lawRegionHash === 'string') lawRegionHash = GetHashKey(lawRegionHash)
    if (typeof stateHash === 'string') stateHash = GetHashKey(stateHash)
 ...
 */
export function setPedBehaviour(ped: number | IPed, behaviour: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
