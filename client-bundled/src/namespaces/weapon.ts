 ...
 */
export function getAllowDualWield(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getBestPedShortarmGuid(ped: number | IPed): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCurrentPed(ped: number | IPed, attachPoint: number): [boolean, number] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCurrentPedEntityIndex(ped: number | IPed, attachPoint: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedAmmoByType(ped: number | IPed, ammoType: number | string): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedBackup(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedGuidAtAttachPoint(ped: number | IPed, attachPoint: number): [boolean, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getDegradation(weaponObject: number | IObject): number {
 ...
 */
export function getPermanentDegradation(weaponObject: number | IObject): number {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function giveDelayedToPed(ped: number | IPed, weaponHash: number | string, ammoCount: number, addReason: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function giveToPed(ped: number | IPed, weaponHash: number | string, ammoCount: number, bForceInHand: boolean, bForceInHolster: boolean, attachPoint: number, bAllowMultipleCopies: boolean, addReason: number | string, bIgnoreUnlocks: boolean, permanentDegradation: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof addReason === 'string') addReason = GetHashKey(addReason)
 ...
 */
export function giveToPedWithOptions(ped: number | IPed): [boolean, any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function hasPedGot(ped: number | IPed, weaponHash: number | string, onlyCheckPlayerInventory: boolean): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function hasGotWeaponComponent(weapon: number | IObject, addonHash: number | string): boolean {
    const _weapon = weapon instanceof IObject ? weapon.handle() : weapon;
    if (typeof addonHash === 'string') addonHash = GetHashKey(addonHash)
 ...
 */
export function isPedArmed(ped: number | IPed, flags: number): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isPedCarrying(ped: number | IPed, weaponHash: number | string): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isAGun(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isBow(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isMeleeWeapon(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isPistol(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isRepeater(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isRevolver(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isRifle(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isShotgun(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function makePedDrop(ped: number | IPed, attachPoint: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function removeComponentFromWeaponObject(weaponObject: number | IObject, component: number | string): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function removeFromPed(ped: number | IPed, weaponHash: number | string, removeReason: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof removeReason === 'string') removeReason = GetHashKey(removeReason)
 ...
 */
export function setAllowAnyDrop(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setCurrentPed(ped: number | IPed, weaponHash: number | string, equipNow: boolean, attachPoint: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function setCurrentPedByGuid(ped: number | IPed): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setInstantlyEquipPickups(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setPedAmmoByType(ped: number | IPed, ammoType: number | string, ammo: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof ammoType === 'string') ammoType = GetHashKey(ammoType)
 ...
 */
export function setPlayerPedQuickSwapByGuid(ped: number | IPed): [any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setVehicleHeading(vehicle: number | IVehicle, seatIndex: number, heading: number): void {
 ...
 */
export function shouldBeDiscardedWhenSwapped(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function _0x000FA7A4A8443AF7(): void {
 ...
 */
export function _0x16D9841A85FA627E(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x183CE355115B6E75(): void {
 ...
 */
export function _0x431240A58484D5D0(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x457B16951AD77C1B(): void {
 ...
 */
export function _0x45E57FDD531C9477(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x4823F13A21F51964(): any {
 ...
 */
export function _0x486C96A0DCD2BC92(): any {
 ...
 */
export function _0x63B83A526329AFBC(): void {
 ...
 */
export function _0x641351E9AD103890(): void {
 ...
 */
export function _0x74C2365FDD1BB48F(): void {
 ...
 */
export function _0x9409C62504A8F9E9(vehicle: number | IVehicle): void {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function _0x9CCA3131E6B53C68(): any {
 ...
 */
export function _0xA2091482ED42EF85(): any {
 ...
 */
export function _0xA3716A77DCF17424(): void {
 ...
 */
export function _0xA769D753922B031B(): void {
 ...
 */
export function _0xB0FB9B196A3D13F0(): void {
 ...
 */
export function _0xC5899C4CD2E2495D(): void {
 ...
 */
export function _0xD53846B9C931C181(): void {
 ...
 */
export function _0xE9B3FEC825668291(): void {
 ...
 */
export function _0xECBB26529A737EF6(): void {
 ...
 */
export function _0xF08D8FEB455F2C8C(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xF252A85B8F3F8C58(weaponCollection: number | string, dualwieldVariant: number | string): boolean {
    if (typeof weaponCollection === 'string') weaponCollection = GetHashKey(weaponCollection)
    if (typeof dualwieldVariant === 'string') dualwieldVariant = GetHashKey(dualwieldVariant)
 ...
 */
export function _0xF2F585411E748B9C(): any {
 ...
 */
export function _0xF8204EF17410BF43(weaponGroupHash: number | string): number {
    if (typeof weaponGroupHash === 'string') weaponGroupHash = GetHashKey(weaponGroupHash)
 ...
 */
export function addAmmoToPed(ped: number | IPed, weaponHash: number | string, amount: number, addReason: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof addReason === 'string') addReason = GetHashKey(addReason)
 ...
 */
export function addAmmoToPedByType(ped: number | IPed, ammoType: number | string, amount: number, addReason: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof ammoType === 'string') ammoType = GetHashKey(ammoType)
    if (typeof addReason === 'string') addReason = GetHashKey(addReason)
 ...
 */
export function attachToHorseHolster(horse: number | IPed, weaponHash: number | string, horseOwner: number | IPed): void {
 ...
 */
export function canPedAccessMounts(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function deleteObjectFromMount(horse: number | IPed): void {
    const _horse = horse instanceof IPed ? horse.handle() : horse;
 ...
 */
export function disableAllSpecialAmmoForPed(ped: number | IPed, weaponHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function disableAmmoTypeForPed(ped: number | IPed, ammoHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function disableAmmoTypeForPedWeapon(ped: number | IPed, weaponHash: number | string, ammoHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function doesPedHavePistol(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function doesPedHaveRepeater(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function doesPedHaveRevolver(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function doesPedHaveRifle(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function doesPedHaveShotgun(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function doesPedHaveSniper(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function enableAllSpecialAmmoForPed(ped: number | IPed, weaponHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function enableAmmoTypeForPed(ped: number | IPed, weaponHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function enableAmmoTypeForPedWeapon(ped: number | IPed, weaponHash: number | string, ammoHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function enableRestore(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function explodePedAmmoType(ped: number | IPed, ammoHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function getAmmoInClipByInventoryUid(ped: number | IPed): [boolean, number, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getAmmoRecommendedTypeFor(weaponHash: number | string): number {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getAmmoTypeFor(weaponHash: number | string): number {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getBestPedInGroup(ped: number | IPed, weaponGroup: number | string): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getBestPedInInventory(ped: number | IPed): [any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCanTwirl(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getCorrectKitEmoteTwirlGun(ped: number | IPed): [boolean, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCurrentAmmoTypeFromGuid(ped: number | IPed): [number, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getCurrentPedAmmoType(ped: number | IPed, weaponObject: number | IObject): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function getDefaultPedCollection(pedModel: number | string): number {
    if (typeof pedModel === 'string') pedModel = GetHashKey(pedModel)
 ...
 */
export function getDefaultUnarmedHash(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getDefaultAttachPoint(weaponHash: number | string): number {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getIgnitedProjectileInVolume(volume: number): [any, any] {
 ...
 */
export function getLockonRangeCurrent(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getLongarmStoreOnDismountState(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getMaxLockonDistanceOfCurrentPed(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getNumPedsRestrainedFromBolas(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedCanSwitch(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedCurrentHeld(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedGunSpinningEquippedKitEmoteTwirl(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedGunSpinningHashFromEmoteVariation(ped: number | IPed, weaponEmoteVariation: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedHogtie(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedInSlot(ped: number | IPed, slotHash: number | string): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof slotHash === 'string') slotHash = GetHashKey(slotHash)
 ...
 */
export function getPedObject(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedWorst(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPlayerPedQuickSwapByGuid(ped: number | IPed): [any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getProjectileInVolume(volume: number): [any, any] {
 ...
 */
export function getAttachPoint(ped: number | IPed, attachPoint: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getDamage(weaponObject: number | IObject): number {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function getDirt(weaponObject: number | IObject): number {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function getEmoteVariation(ped: number | IPed, variation: number): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getFromDefaultPedWeaponCollection(weaponCollection: number | string, weaponGroup: number | string): number {
    if (typeof weaponCollection === 'string') weaponCollection = GetHashKey(weaponCollection)
    if (typeof weaponGroup === 'string') weaponGroup = GetHashKey(weaponGroup)
 ...
 */
export function getFromMount(mount: number | IPed): number {
 ...
 */
export function getGunSpinningWeaponEmoteTrickTypeHash(emote: number | string, weaponEmoteTrickType: number): number {
 ...
 */
export function getHasMultipleAmmoTypes(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getLastGiven(): any {
 ...
 */
export function getName(weaponHash: number | string): string {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getName2(weaponHash: number | string): string {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getNameWithPermanentDegradation(weaponHash: number | string, permanentDegradationLevel: number): string {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getScale(weaponObject: number | IObject): number {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function getSoot(weaponObject: number | IObject): number {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function getStatId(weaponHash: number | string): number {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getTypeFromAmmoType(ammoType: number | string): number {
    if (typeof ammoType === 'string') ammoType = GetHashKey(ammoType)
 ...
 */
export function getUnlock(weaponHash: number | string): number {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function giveCollectionToPed(ped: number | IPed, weaponCollection: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponCollection === 'string') weaponCollection = GetHashKey(weaponCollection)
 ...
 */
export function giveComponentToEntity(entity: number | IEntity, componentHash: number | string, weaponHash: number | string): void {
 ...
 */
export function giveComponentToWeaponObject(ped: number | IPed, componentHash: number | string): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof componentHash === 'string') componentHash = GetHashKey(componentHash)
 ...
 */
export function hasEntityBeenDamagedBy(entity: number | IEntity, weaponName: number | string, weaponType: number): boolean {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof weaponName === 'string') weaponName = GetHashKey(weaponName)
 ...
 */
export function hasEntityBeenDamagedByRecently(entity: number | IEntity, weaponHash: number | string, ms: number): boolean {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function hasPedGotComponent(ped: number | IPed, componentHash: number | string, weaponHash: number | string): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof componentHash === 'string') componentHash = GetHashKey(componentHash)
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function hidePeds(ped: number | IPed, immediately: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function holsterPeds(ped: number | IPed, immediately: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isAmmoSilent(ammoHash: number | string): boolean {
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function isAmmoSilent2(ammoHash: number | string): boolean {
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function isAmmoTypeValidFor(weaponHash: number | string, ammoHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function isAmmoValid(ammoHash: number | string): boolean {
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function isPedCarryingSniperAtAttachPoint(ped: number | IPed, attachPoint: number): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isPedCurrentHolstered(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isPedHolding(ped: number | IPed, weapon: number | string): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isPedTakingPoisonGasDamage(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isTargetPedConstrainedByPedUsingBolas(ped: number | IPed, targetPed: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isBinoculars(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isCloseRange(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isHolsterStateChanging(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isKit(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isKit2(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isKnife(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isLantern(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isLasso(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isOneHanded(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isSilent(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isSniper(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isThrowable(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isTorch(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function isTwoHanded(weaponHash: number | string): boolean {
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function makePedReload(ped: number | IPed): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function refillAmmoInClip(ped: number | IPed): [any, any] {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function refillAmmoInCurrentPed(ped: number | IPed): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function registerObjectForIgnition(weaponObject: number | IEntity): void {
 ...
 */
export function removeAllPedAmmo(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function removeAmmoFromPed(ped: number | IPed, weaponHash: number | string, amount: number, removeReason: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof removeReason === 'string') removeReason = GetHashKey(removeReason)
 ...
 */
export function removeAmmoFromPedByType(ped: number | IPed, ammoHash: number | string, amount: number, removeReason: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
    if (typeof removeReason === 'string') removeReason = GetHashKey(removeReason)
 ...
 */
export function removeComponentFromPed(ped: number | IPed, componentHash: number | string, weaponHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof componentHash === 'string') componentHash = GetHashKey(componentHash)
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function removeFromPedByGuid(ped: number | IPed, removeReason: number | string): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof removeReason === 'string') removeReason = GetHashKey(removeReason)
 ...
 */
export function sendToInventory(ped: number | IPed, weaponHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function setActiveGunSpinningEquipKitEmoteTwirl(ped: number | IPed, emote: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof emote === 'string') emote = GetHashKey(emote)
 ...
 */
export function setActiveGunSpinningKitEmoteTwirl(ped: number | IPed, weaponEmoteTrickType: number, spin: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof spin === 'string') spin = GetHashKey(spin)
 ...
 */
export function setAllowDualWield(ped: number | IPed, allow: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setAmmoInTurret(vehicle: number | IVehicle, turretHash: number | string, ammo: number): void {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
    if (typeof turretHash === 'string') turretHash = GetHashKey(turretHash)
 ...
 */
export function setAmmoTypeForPed(ped: number | IPed, weaponHash: number | string, ammoHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function setAmmoTypeForPedInventory(ped: number | IPed, ammoHash: number | string): any {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof ammoHash === 'string') ammoHash = GetHashKey(ammoHash)
 ...
 */
export function setArrowTrailFx(ped: number | IPed, trailHash: number | string): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    if (typeof trailHash === 'string') trailHash = GetHashKey(trailHash)
 ...
 */
export function setForceAutoEquip(ped: number | IPed, toggle: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setForceCurrentIntoCockedState(ped: number | IPed, attachPoint: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setGunSpinningInventorySlotIdActivate(ped: number | IPed, emoteType: number): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setInstantlyStoreLongarmsOnDismount(ped: number | IPed, storeLongarms: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setPedAllsVisibility(ped: number | IPed, visible: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setPedAttachPointVisibility(ped: number | IPed, attachPoint: number, visible: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setPedOnBack(ped: number | IPed, disableAnim: boolean): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setProjectileEffectRadius(projectile: number | IEntity, radius: number): void {
 ...
 */
export function setProjectileFuseTime(projectile: number | IEntity, fuseTime: number): void {
    const _projectile = projectile instanceof IEntity ? projectile.handle() : projectile;
 ...
 */
export function setVehicleHeadingLimits(vehicle: number | IVehicle, minHeading: number, maxHeading: number): void {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function setVehicleHeadingLimits2(vehicle: number | IVehicle, minHeading: number, maxHeading: number): any {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function setVehicleReloadMode(vehicle: number | IVehicle, noReload: boolean): void {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function setDamage(weaponObject: number | IObject, level: number): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function setDegradation(weaponObject: number | IObject, level: number): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function setDirt(weaponObject: number | IObject, level: number): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function setLevelThreshold(weaponObject: number | IObject, threshold: number): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function setScale(weaponObject: number | IObject, scale: number): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
 ...
 */
export function setSoot(weaponObject: number | IObject, level: number): void {
    const _weaponObject = weaponObject instanceof IObject ? weaponObject.handle() : weaponObject;
