 ...
 */
export function taskEnterCover(ped: number | IPed): void {
 ...
 */
export function taskExitCover(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
    TaskExitCover(_ped);
}
 ...
 */
export function _0x3C7A9C2C953128FE(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x53E4D0C079CA6855(handle: number): number {
 ...
 */
export function _0xEBA51A294C73292E(): any {
 ...
 */
export function activateCoverLayer(): string {
 ...
 */
export function addCoverBlockingArea(): any {
 ...
 */
export function addScriptedCoverPoint(): [number, any] {
 ...
 */
export function areLoadCoverAnimsLoaded(ped: number | IPed): boolean {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function deactivateCoverLayer(): string {
 ...
 */
export function getCoverPointStateFromPed(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedCoverPointTransitionState(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getPedFromCoverPoint(coverpoint: number): number {
 ...
 */
export function requestFlinchCoverAnim(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function stopRunningCoverAnims(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function taskAiSeekCoverToCoverPoint(): any {
