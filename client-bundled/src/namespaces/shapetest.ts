 ...
 * };
 * 
 * Hash: 0xEDE8AC7C5108FB1D | Since: 1207 | API-Set: unknown
 */
 ...
 * 
 * Hash: 0x377906D8A31E5586 | Since: 1207 | API-Set: unknown
 */
export function startExpensiveSynchronousLosProbe(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, flags: number, entityToIgnore: number | IEntity): number {
 ...
 * No comment provided
 * 
 * Hash: 0xFE466162C4401D18 | Since: 1207 | API-Set: unknown
 */
export function startBox(pos: Vector3, dimensionsX: number, dimensionsY: number, dimensionsZ: number, rot: Vector3, rotationOrder: number, flags: number, entityToIgnore: number | IEntity, options: number): number {
    const _entityToIgnore = entityToIgnore instanceof IEntity ? entityToIgnore.handle() : entityToIgnore;
 ...
 * No comment provided
 * 
 * Hash: 0x28579D1B8F8AAC80 | Since: 1207 | API-Set: unknown
 */
export function startCapsule(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, radius: number, flags: number, entityToIgnore: number | IEntity): number {
    const _entityToIgnore = entityToIgnore instanceof IEntity ? entityToIgnore.handle() : entityToIgnore;
 ...
 * 
 * Hash: 0x7EE9F5D83DD4F90E | Since: 1207 | API-Set: unknown
 */
 ...
 * 
 * Hash: 0x9839013D8B6014F1 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 * 
 * Hash: 0xAA5B7C8309F73230 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 * 
 * Hash: 0x04AA59CA40571C2E | Since: 1207 | API-Set: unknown
 */
export function _0x04AA59CA40571C2E(): any {
