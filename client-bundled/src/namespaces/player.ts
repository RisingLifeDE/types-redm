 ...
 */
export function boostHorseSpeedForTime(player: number | string | IPlayer, speedBoost: number, duration: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetCustomEntityTint(entity: number | IEntity, red: number, green: number, blue: number): void {
 ...
 */
export function forceCleanupForAllThreadsWithThisName(cleanupFlags: number): string {
 ...
 */
export function getDiscoverableNameHashAndTypeForEntity(entity: number | IEntity): [number, number] {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function getHasDiscoveredCharacterNameMp(discoveryHash: number | string): boolean {
 ...
 */
export function getIsUiPromptActive(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getMountOwnedBy(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getInteractionTargetEntity(player: number | string | IPlayer): [boolean, number] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getTargetCharacterNameForLocal(ped: number | IPed): number {
 ...
 */
export function getTargetCharacterNameScriptOverrideHash(ped: number | IPed): number {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getTargetCharacterNameScriptOverrideRawString(ped: number | IPed): string {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getWantedLevelRadius(): number {
 ...
 */
export function isTargettingEntity(player: number | string | IPlayer, entity: number | IEntity, withWeapon: boolean): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setLockonToFriendlys(player: number | string | IPlayer, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setMinTimeBeforeHorseBucking(mount: number | IPed, iMinBuckTime: number): void {
 ...
 */
export function setPedAsTempHorse(player: number | string | IPlayer, horse: number | IPed): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setControl(player: number | string | IPlayer, toggle: boolean, flags: number, bPreventHeadingChange: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setForcedAim(player: number | string | IPlayer, toggle: boolean, ped: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function setModel(player: number | string | IPlayer, modelHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setStaminaRechargeMultiplier(player: number | string | IPlayer, multiplier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setTeam(player: number | string | IPlayer, team: number, bRestrictToThisScript: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setWeaponTypeDamageModifier(player: number | string | IPlayer, weaponHash: number | string, damageModifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function simulateInputGait(player: number | string | IPlayer, speed: number, duration: number, heading: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function startTeleport(player: number | string | IPlayer, pos: Vector3, heading: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x00B156AFEBCC5AE0(): void {
 ...
 */
export function _0x03B4B759A8990505(): any {
 ...
 */
export function _0x06E1FB78B1E59CA5(ped: number | IPed): void {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x086549F3B0381CB1(): void {
 ...
 */
export function _0x0869D499A7848309(): void {
 ...
 */
export function _0x08E22898A6AF4905(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x0B7803F6F7BB43E0(): any {
 ...
 */
export function _0x0F4EAF69DA41AF43(): any {
 ...
 */
export function _0x0F9CF06986300875(): void {
 ...
 */
export function _0x107F2A66E1C4C83A(): void {
 ...
 */
export function _0x113EF458AB6CDA67(): void {
 ...
 */
export function _0x12E09E278C6C29B7(): void {
 ...
 */
export function _0x14E57F88BA0A07FC(location: number | string): void {
 ...
 */
export function _0x19B2C7A6C34FAD54(): any {
 ...
 */
export function _0x1AD8AD999C27F44A(): void {
 ...
 */
export function _0x1D256EED194F5B58(): void {
 ...
 */
export function _0x1E8099F449ABB0BA(): any {
 ...
 */
export function _0x1F488807BC8E0630(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x1FDA57E8908F2609(player: number | string | IPlayer, ped: number | IPed, useSteerassist: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x21091B4BEB6376EE(): any {
 ...
 */
export function _0x216BC0D3D2E413D2(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x22B3CABEDDB538B2(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x263D69767F76059C(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x2BB8D58E88777499(): void {
 ...
 */
export function _0x2BEED53B912537D0(): void {
 ...
 */
export function _0x2C2D287748E8E9B7(): void {
 ...
 */
export function _0x2E1ABE627C95ED9B(): any {
 ...
 */
export function _0x2E67707BEC52CA4B(): void {
 ...
 */
export function _0x310CE349E0C0EC4B(player: number | string | IPlayer, ped: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x325434C68358D282(toggle: boolean): void {
 ...
 */
export function _0x35A33783EC3C3448(): void {
 ...
 */
export function _0x39D8D7082BC34B72(): void {
 ...
 */
export function _0x3A8611BD7BDE84F7(): void {
 ...
 */
export function _0x3ACAC8832E77BC93(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x3AD212429E095EFB(): void {
 ...
 */
export function _0x3B296934DB026873(): void {
 ...
 */
export function _0x3BB84F812E052C90(): void {
 ...
 */
export function _0x3C4AE8506638C7E2(): void {
 ...
 */
export function _0x3D9DA5C9EFD20D88(): void {
 ...
 */
export function _0x3DAABE78A23694BC(): void {
 ...
 */
export function _0x45EF176B532CA851(): void {
 ...
 */
export function _0x497A18F8F88AA9D8(): void {
 ...
 */
export function _0x4D1699543B1C023C(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x4DBC4873707E8FD6(): void {
 ...
 */
export function _0x4EC8BE63B8A5D4EF(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x4F0D2256AAE94EDA(): void {
 ...
 */
export function _0x51139D8C17B16FBC(): any {
 ...
 */
export function _0x57028FD99886F6F9(): boolean {
 ...
 */
export function _0x570A13A4CA2799BB(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x57D9991DC1334151(): any {
 ...
 */
export function _0x585CE159DB46FADB(): void {
 ...
 */
export function _0x5B7B97E99F84138B(): any {
 ...
 */
export function _0x5C2E5E3CAEEB1F58(): void {
 ...
 */
export function _0x621D1B289CAF5978(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x628E742FE1F79C4A(): void {
 ...
 */
export function _0x65887EAC535A0B0C(): void {
 ...
 */
export function _0x67659A8F248E0141(): void {
 ...
 */
export function _0x6852288340B43239(): any {
 ...
 */
export function _0x694FFA4308060CD1(): void {
 ...
 */
export function _0x6C54E69516CC56BD(): any {
 ...
 */
export function _0x6EDB5D08CB03E763(): void {
 ...
 */
export function _0x73EB2EF2E92D23BF(): boolean {
 ...
 */
export function _0x747257807B8721CE(): any {
 ...
 */
export function _0x76F7E1BCD623A429(): void {
 ...
 */
export function _0x77B0B6D17A3AC9AA(): void {
 ...
 */
export function _0x77E83C315A3B31CA(): void {
 ...
 */
export function _0x7AE93C45EC14A166(player: number | string | IPlayer): [boolean, number] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x818241B3EDA84191(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x83C989D5B5B5B466(): void {
 ...
 */
export function _0x84481018E668E1B8(player: number | string | IPlayer, ped: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0x8591EE69CC3ED257(player: number | string | IPlayer, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x8702D9150D9FBB3D(): any {
 ...
 */
export function _0x8F44EBB3BA8F6D44(): void {
 ...
 */
export function _0x9044835BE9D9DBFE(): void {
 ...
 */
export function _0x9073EC5456651A90(): void {
 ...
 */
export function _0x908D4B72854C8F62(): void {
 ...
 */
export function _0x927861B2C08DBEA5(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x929DDD5538F3DF1F(): void {
 ...
 */
export function _0x93624B36E8851B42(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0x9422743A5BA50E10(): any {
 ...
 */
export function _0x9461A8FAB0378E5B(): void {
 ...
 */
export function _0x9AFCF9FE1884BF62(): void {
 ...
 */
export function _0x9FC5A003FB76EDBD(): void {
 ...
 */
export function _0xA28056CD1B04B250(): void {
 ...
 */
export function _0xA342495F93B7B838(): void {
 ...
 */
export function _0xA54000D4BFD90BDE(): any {
 ...
 */
export function _0xAAED694CE814817F(): any {
 ...
 */
export function _0xB15CD2F9932C9AB5(): any {
 ...
 */
export function _0xB331D8A73F9D2BDF(player: number | string | IPlayer): [boolean, any] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xBA5CA1FEB5DE0DF6(): void {
 ...
 */
export function _0xBB6EA5D59E926095(category: number, emote: number | string): void {
 ...
 */
export function _0xBD96185264DDAAEA(): void {
 ...
 */
export function _0xBEA3A6E5F5F79A6F(): any {
 ...
 */
export function _0xBED386157F65942C(): void {
 ...
 */
export function _0xBEFED69CE8317F91(): any {
 ...
 */
export function _0xC177C827CEFC0AA4(): void {
 ...
 */
export function _0xC4873B053054C04B(): void {
 ...
 */
export function _0xC58CE6824E604DEC(): void {
 ...
 */
export function _0xC71D07C96946E263(): void {
 ...
 */
export function _0xC74EB3F2EC169F6B(): any {
 ...
 */
export function _0xC900A465364A85D6(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xC93A9A45430D484E(): any {
 ...
 */
export function _0xCA59808E51FD67C4(): void {
 ...
 */
export function _0xCB0B9506BC91E441(): void {
 ...
 */
export function _0xCB61A63AA53D7D22(): void {
 ...
 */
export function _0xCD7CA3013FD12749(): void {
 ...
 */
export function _0xCDDD4B74660E2335(): void {
 ...
 */
export function _0xCEDC16930526F728(): void {
 ...
 */
export function _0xCFB2EED4FCB7BD77(): void {
 ...
 */
export function _0xD1F6B912785BFD35(): any {
 ...
 */
export function _0xD288E02E364972D2(): void {
 ...
 */
export function _0xDA9D7BE231FE865F(): any {
 ...
 */
export function _0xDAB6A2FC56B7DE65(): any {
 ...
 */
export function _0xDD33A82352C4652F(player: number | string | IPlayer, ped: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xE1D356F5A66D0FFA(emote: number | string): boolean {
    if (typeof emote === 'string') emote = GetHashKey(emote)
 ...
 */
export function _0xE50A67C33514A390(): any {
 ...
 */
export function _0xE7F8707269544B29(player: number | string | IPlayer, ped: number | IPed): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function _0xE956C2340A76272E(): any {
 ...
 */
export function _0xEACEBAAE0A33FB3F(): void {
 ...
 */
export function _0xEBB6E27AC2FF32DA(): void {
 ...
 */
export function _0xEBFF94328FF7A18A(): void {
 ...
 */
export function _0xF21C7A3F3FFBA629(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xF4CB347D7B5EB0FD(): any {
 ...
 */
export function _0xF993373285053D77(): void {
 ...
 */
export function _0xFA437FA0738C370C(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function _0xFA7DAAE3959E6C7B(): void {
 ...
 */
export function addAmbientInteractiveFocusPreset(player: number | string | IPlayer, ped: number | IPed, pos: Vector3, targetEntity: number | IEntity): [string, string] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function addAmbientInteractiveFocusPresetAtCoords(player: number | string | IPlayer, pos: Vector3, targetEntity: number | IEntity): [Vector3, string, string] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _targetEntity = targetEntity instanceof IEntity ? targetEntity.handle() : targetEntity;
 ...
 */
export function addAsFollowTarget(player: number | string | IPlayer, ped: number | IPed, followMode: number, followPriority: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function clearBountyTarget(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function clearDeadeyeAuraIntensity(player: number | string | IPlayer, bitflag: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function disableInteractiveFocusPreset(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleeyeSetSprintBehavior(player: number | string | IPlayer, disabled: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeAddParticleEffectToEntity(entity1: number | IEntity, entity2: number | IEntity, heading: number): void {
 ...
 */
export function eagleEyeAreAllTrailsHidden(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeCanFocusOnTrack(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeClearRegisteredTrails(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeDisableTrackingTrail(entity: number | IEntity): string {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function eagleEyeGetTrackedPedId(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeRemoveParticleEffectFromEntity(entity1: number | IEntity, entity2: number | IEntity): void {
    const _entity1 = entity1 instanceof IEntity ? entity1.handle() : entity1;
    const _entity2 = entity2 instanceof IEntity ? entity2.handle() : entity2;
 ...
 */
export function eagleEyeSetColor(player: number | string | IPlayer): any {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetCustomDistance(entity: number | IEntity, distance: number): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function eagleEyeSetDrainRateModifier(player: number | string | IPlayer, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetFocusOnAssociatedClueTrail(player: number | string | IPlayer, linkedWaypointPed: number | IEntity): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetHideAllTrails(player: number | string | IPlayer, hide: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetRange(player: number | string | IPlayer, range: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetRegisteredEntityGlow(entity: number | IEntity, enable: boolean): void {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function eagleEyeSetTrackingUpgrade(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function eagleEyeSetTrackingUpgrade2(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function enableCustomDeadeyeAbility(player: number | string | IPlayer, enable: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function enableEagleeye(player: number | string | IPlayer, enable: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function formatNameString(): [string, string] {
 ...
 */
export function getActiveHorseFor(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getAiDefenseModifierAgainstAi(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getConstructedDiscoveredCharacterName(p0: number | string, model: boolean, outfit: boolean): number {
 ...
 */
export function getDeadeyeAbilityDepletionDelay(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getDeadeyeAbilityLevel(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getHasDiscoveredCharacterNameSp(player: number | string | IPlayer, discoveryHash: number | string): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof discoveryHash === 'string') discoveryHash = GetHashKey(discoveryHash)
 ...
 */
export function getIsDeadeyeTaggingEnabled(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getNumDeadeyeMarksOnPed(player: number | string | IPlayer, ped: number | IPed): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getNumMarkedDeadeyeTargets(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getPedsDamagedByRecently(player: number | string | IPlayer, duration: number): [boolean, any] {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getCachedDeadEyeAmount(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getDeadEye(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getDeadEyeMeterLevel(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getHealth(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getHealthRechargeMultiplier(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getHuntingWagon(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getMaxDeadEye(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getMood(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getOwnerOfMount(mount: number | IPed): number | string {
    const _mount = mount instanceof IPed ? mount.handle() : mount;
 ...
 */
export function getOwnerOfVehicle(vehicle: number | IVehicle): number | string {
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function getPed2(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getRequiredDeadEyeAmount(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getResetFlag(player: number | string | IPlayer, playerResetFlag: number): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getSpecialAbilityMultiplier(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 * No comment provided
 * 
 * Hash: 0x0FF421E467373FCF | Since: 1207 | API-Set: unknown
 */
export function getStamina(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getStaminaDepletionMultiplier(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getStaminaRechargeMultiplier(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getUiPromptForPedIsEnabled(player: number | string | IPlayer, ped: number | IPed, promptType: number, promptMode: number): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function getUiPromptIsDisabled(player: number | string | IPlayer, promptType: number, promptMode: number): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getWeaponDamage(player: number | string | IPlayer, weaponHash: number | string): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof weaponHash === 'string') weaponHash = GetHashKey(weaponHash)
 ...
 */
export function getSaddleHorseFor(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getTempHorse(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function getVehicleOwnedBy(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function hasDamagedAnyPedRecently(player: number | string | IPlayer, duration: number): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isDeadeyeAbilityLocked(player: number | string | IPlayer, abilityType: number): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isEagleEyeRegisteredForEntity(player: number | string | IPlayer, entity: number | IEntity): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isFollowingTarget(player: number | string | IPlayer, ped: number | IPed): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function isFreeFocusing(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isInScope(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isMountOnRoad(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isOnMountLockonEntity(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isSecondarySpecialAbilityActive(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function isSecondarySpecialAbilityEnabled(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function modifyInfiniteTrailVision(player: number | string | IPlayer, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function modifyDiscoveredCharacterNameMpSetUndiscovered(discoveryHash: number | string): void {
    if (typeof discoveryHash === 'string') discoveryHash = GetHashKey(discoveryHash)
 ...
 */
export function modifyUiPrompt(player: number | string | IPlayer, promptType: number, promptMode: number, disabled: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function modifyUiPromptForPed(player: number | string | IPlayer, ped: number | IPed, promptType: number, promptMode: number, enabled: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function networkHasValidPed(player: number | string | IPlayer): boolean {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function registerEagleEyeForEntity(player: number | string | IPlayer, entity: number | IEntity): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function registerEagleEyeTrailsForEntity(player: number | string | IPlayer, entity: number | IEntity): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function removeAsFollowTarget(player: number | string | IPlayer, ped: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 */
export function resetDeadeyeAuraEffect(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function secondarySpecialAbilitySetActive(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function secondarySpecialAbilitySetDisabled(player: number | string | IPlayer, disabled: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setAiDefenseModifierAgainstAi(player: number | string | IPlayer, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setBountyTarget(player: number | string | IPlayer, target: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setBowDrawReductionTimeInDeadeye(player: number | string | IPlayer, drawReductionTime: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setBowStaminaDrainSpeed(player: number | string | IPlayer, staminaDrain: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDamageCloseDistanceBonus(player: number | string | IPlayer, closeRangeLowerBound: number, closeRangeUpperBound: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDamageCloseDistanceBonusTotal(player: number | string | IPlayer, closeDamageBonus: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDamageFarDistanceBonus(player: number | string | IPlayer, farRangeLowerBound: number, farRangeUpperBound: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDamageFarDistanceBonusTotal(player: number | string | IPlayer, farDamageBonus: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeAbilityDepletionDelay(player: number | string | IPlayer, delay: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeAbilityLevel(player: number | string | IPlayer, level: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeAbilityLocked(player: number | string | IPlayer, abilityType: number, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeEntityAura(player: number | string | IPlayer, flag: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeEntityAuraIntensityWithFlag(player: number | string | IPlayer, intensity: number, flag: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeTaggingConfig(player: number | string | IPlayer, filter: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadeyeTaggingEnabled(player: number | string | IPlayer, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDisableWantedLevel(player: number | string | IPlayer, disable: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setLocalPersonaAbilityFlag(flagId: number, toggle: boolean): void {
 ...
 */
export function setLockonFocusFireVfx(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setPedActiveHorse(player: number | string | IPlayer, horse: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _horse = horse instanceof IPed ? horse.handle() : horse;
 ...
 */
export function setPedAsSaddleHorseFor(player: number | string | IPlayer, mount: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _mount = mount instanceof IPed ? mount.handle() : mount;
 ...
 */
export function setAimWeapon(player: number | string | IPlayer, weapon: number | string, weaponDrawOrder: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setCanMercyKill(player: number | string | IPlayer, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setCanPickupHat(player: number | string | IPlayer, canPickup: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setCooperatePromptThisFrame(player: number | string | IPlayer, targetPed: number | IPed, promptOrder: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDamageInfoOverride(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDeadEyeAuraByHash(player: number | string | IPlayer, auraColorHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof auraColorHash === 'string') auraColorHash = GetHashKey(auraColorHash)
 ...
 */
export function setDefenseModifier(player: number | string | IPlayer, weaponDefenseMod: number, meleeDefenseMod: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setDefenseTypeModifier(player: number | string | IPlayer, _type: number, defenseModifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setExplosiveWeaponDamageModifier(player: number | string | IPlayer, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setHasDiscoveredCharacterNameMp(discoveryHash: number | string): void {
    if (typeof discoveryHash === 'string') discoveryHash = GetHashKey(discoveryHash)
 ...
 */
export function setHasDiscoveredCharacterNameSp(player: number | string | IPlayer, discoveryHash: number | string): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof discoveryHash === 'string') discoveryHash = GetHashKey(discoveryHash)
 ...
 */
export function setHatAccess(player: number | string | IPlayer, flag: number, allow: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setHealthRechargeTimeModifier(player: number | string | IPlayer, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setHuntingWagon(player: number | string | IPlayer, wagon: number | IVehicle): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setInteractionNegativeResponse(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setInteractionPositiveResponse(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setInVehicleTargetingMode(targetMode: number): void {
 ...
 */
export function setLassoDamagePerSecond(player: number | string | IPlayer, damage: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setLocalAccuracyFloorModifier(player: number | string | IPlayer, accuracy: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setManageBuffSuperJump(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setMaxAmmoOverrideForAmmoType(player: number | string | IPlayer, ammoType: number | string, amount: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof ammoType === 'string') ammoType = GetHashKey(ammoType)
 ...
 */
export function setMeleePromptText(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setMood(player: number | string | IPlayer, mood: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setMountStateActive(player: number | string | IPlayer, active: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setOwnsMount(player: number | string | IPlayer, mount: number | IPed): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _mount = mount instanceof IPed ? mount.handle() : mount;
 ...
 */
export function setOwnsVehicle(player: number | string | IPlayer, vehicle: number | IVehicle): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _vehicle = vehicle instanceof IVehicle ? vehicle.handle() : vehicle;
 ...
 */
export function setPickupPromptVisible(player: number | string | IPlayer, enable: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setPromptLeaveText(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setRemoteAccuracyFloorModifier(player: number | string | IPlayer, accuracy: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setResetFlag(player: number | string | IPlayer, playerResetFlag: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSitPromptText(player: number | string | IPlayer): string {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setStaminaSprintDepletionMultiplier(player: number | string | IPlayer, multiplier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setTotalAccuracyModifier(player: number | string | IPlayer, accuracy: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setTrampleDamageModifier(player: number | string | IPlayer, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setWeaponDrawSpeed(player: number | string | IPlayer, weapon: number | string, speed: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof weapon === 'string') weapon = GetHashKey(weapon)
 ...
 */
export function setWeaponGroupAsInstantKill(player: number | string | IPlayer, weaponGroup: number | string, toggle: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof weaponGroup === 'string') weaponGroup = GetHashKey(weaponGroup)
 ...
 */
export function setWeaponGroupDamageModifier(player: number | string | IPlayer, weaponGroup: number | string, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    if (typeof weaponGroup === 'string') weaponGroup = GetHashKey(weaponGroup)
 ...
 */
export function setReceivedDamageTakenOnHorsebackModifier(player: number | string | IPlayer, damageDecrease: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setShowInfoCard(player: number | string | IPlayer, showingInfoCard: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSpecialAbilityActivationCost(player: number | string | IPlayer, activationCost: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSpecialAbilityDisableTimer(player: number | string | IPlayer, timer: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSpecialAbilityDurationCost(player: number | string | IPlayer, durationCost: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSpecialAbilityMultiplier(player: number | string | IPlayer, multiplier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setSpecialAbilityType(player: number | string | IPlayer, _type: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function setWeaponDegradationModifier(player: number | string | IPlayer, modifier: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilityDrainByAmount(player: number | string | IPlayer, amount: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilityGetAmountCached(player: number | string | IPlayer): number {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilityRestoreByAmount(player: number | string | IPlayer, amount: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilityRestoreOuterRing(player: number | string | IPlayer, amount: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilitySetActivate(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilitySetDisabled(player: number | string | IPlayer, disabled: boolean): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilitySetEagleEyeDisabled(player: number | string | IPlayer): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function specialAbilityStartRestore(player: number | string | IPlayer, abilityType: number): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
 ...
 */
export function unregisterEagleEyeForEntity(player: number | string | IPlayer, entity: number | IEntity): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function unregisterEagleEyeTrailsForEntity(player: number | string | IPlayer, entity: number | IEntity): void {
    const _player = player instanceof IPlayer ? player.playerId() : player;
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
