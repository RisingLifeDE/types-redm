 ...
 */
export function getCatagory(missionId: number | string): number {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function getHighScore(missionId: number | string): number {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function getRating(missionId: number | string): number {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function getReplayState(): number {
 ...
 */
export function getTextureName(missionId: number | string): number {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function getTextureTxd(missionId: number | string): number {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function isRequiredStoryMission(missionId: number | string): boolean {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function setHighScore(missionId: number | string, score: number): void {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function setRatingScores(missionId: number | string, bronzeScore: number, silverScore: number, goldScore: number): void {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function setReplayLockedForCategory(category: number | string, locked: boolean): void {
 ...
 */
export function wasCompleted(missionId: number | string): boolean {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function isReplayCategoryLocked(category: number | string): boolean {
    if (typeof category === 'string') category = GetHashKey(category)
 ...
 */
export function setMissionRating(missionId: number | string, rating: number): void {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function setReplayStateLocked(missionId: number | string, replayState: number): void {
    if (typeof missionId === 'string') missionId = GetHashKey(missionId)
 ...
 */
export function timecycleBoxDelete(): void {
 ...
 */
export function timecycleBoxExists(): boolean {
 ...
 */
export function timecycleBoxSetModifier(timecycleName: string): void {
