 ...
 */
export function filloutItemByName(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutItemEffectIdInfo(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutItemInfo(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function isBuyableAwardValid(award: number | string): boolean {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function _0x17721003A66C72BF(shopType: number | string, key: number | string): [boolean, any] {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function _0x388088BFF3681189(bundle: number | string, costtype: number | string): number {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
 ...
 */
export function _0x3A0B667ABFF87F6E(): boolean {
 ...
 */
export function _0x48229CE0C7938237(award: number | string): number {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function _0x537A0555F62CA01A(key: number | string): boolean {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function _0x799FCD53358ED5FA(bundle: any): number {
 ...
 */
export function _0x7A35A72A692BE9DB(): number {
 ...
 */
export function _0x8D029948CA29409B(award: number | string, index: number): [boolean, any] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function _0xAA29A5F13B2C20B2(p1: number | string): number {
 ...
 */
export function _0xC4146375D8A0B374(bundle: any, index: number): boolean {
 ...
 */
export function canEquipItemOnCategory(key: number | string, category: number | string, slotId: number | string): boolean {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function createItemCollection(comparisonType: number): [number, any, number] {
 ...
 */
export function doesBundleHaveTag(bundle: number | string, tag: number | string, tagType: number | string): boolean {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
    if (typeof tag === 'string') tag = GetHashKey(tag)
    if (typeof tagType === 'string') tagType = GetHashKey(tagType)
 ...
 */
export function doesItemHaveTag(item: number | string, tag: number | string, tagType: number | string): boolean {
 ...
 */
export function filloutAcquireCost(key: number | string, costtype: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
    if (typeof costtype === 'string') costtype = GetHashKey(costtype)
 ...
 */
export function filloutAwardAcquireCost(award: number | string, costtype: number | string, index: number): [boolean, any] {
    if (typeof award === 'string') award = GetHashKey(award)
    if (typeof costtype === 'string') costtype = GetHashKey(costtype)
 ...
 */
export function filloutAwardItemInfo(award: number | string, index: number): [boolean, number] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function filloutBundle(bundle: number | string, costtype: number | string, index: number): [boolean, any] {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
    if (typeof costtype === 'string') costtype = GetHashKey(costtype)
 ...
 */
export function filloutBundleUiData(bundle: number | string): [boolean, any] {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
 ...
 */
export function filloutBuyAwardAcquireCosts(award: number | string): [boolean, any, number] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function filloutBuyAwardUiData(award: number | string): [boolean, any] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function filloutItem(key: number | string, costtype: number | string, index: number): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
    if (typeof costtype === 'string') costtype = GetHashKey(costtype)
 ...
 */
export function filloutItemEffectIds(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutModifier(key: number | string, index: number): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutPriceModifierByKey(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutSatchelData(key: number | string): [boolean, number] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutSellPrice(key: number | string, sellType: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
    if (typeof sellType === 'string') sellType = GetHashKey(sellType)
 ...
 */
export function filloutTagData(key: number | string): [boolean, any, number] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function filloutUiData(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getAcquireCost(key: number | string, index: number): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getAcquireCostsCount(key: number | string): number {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getAcquireCostsCountFromCostType(key: number | string, costtype: number | string): number {
    if (typeof key === 'string') key = GetHashKey(key)
    if (typeof costtype === 'string') costtype = GetHashKey(costtype)
 ...
 */
export function getAwardAcquireCost(award: number | string, index: number): [boolean, any] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function getAwardAcquireCostCount(key: number | string): number {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getAwardAcquireCostCountFromCostType(award: number | string, costtype: number | string): number {
    if (typeof award === 'string') award = GetHashKey(award)
    if (typeof costtype === 'string') costtype = GetHashKey(costtype)
 ...
 */
export function getAwardCostModifiers(award: number | string): [boolean, any] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function getAwardInfo(award: number | string): [boolean, any] {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function getAwardItemCount(award: number | string): number {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function getBundleAcquireCostModifiers(bundle: number | string): [boolean, any] {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
 ...
 */
export function getBundleId(bundle: number | string): number {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
 ...
 */
export function getBundleItemCount(bundleId: number): [number, any] {
 ...
 */
export function getBundleItemInfo(bundleId: number, index: number): [boolean, any, number] {
 ...
 */
export function getCollectionSize(collectionId: number): number {
 ...
 */
export function getComponentItem(collectionId: number, index: number): [boolean, number] {
 ...
 */
export function getFitsSlotCount(category: number | string): number {
    if (typeof category === 'string') category = GetHashKey(category)
 ...
 */
export function getFitsSlotInfo(category: number | string, index: number): [boolean, number] {
    if (typeof category === 'string') category = GetHashKey(category)
 ...
 */
export function getHasSlotCount(category: number | string): number {
    if (typeof category === 'string') category = GetHashKey(category)
 ...
 */
export function getHasSlotInfo(category: number | string, index: number): [boolean, number] {
    if (typeof category === 'string') category = GetHashKey(category)
 ...
 */
export function getItemPathset(key: number | string, defaultPathset: number | string): number {
    if (typeof key === 'string') key = GetHashKey(key)
    if (typeof defaultPathset === 'string') defaultPathset = GetHashKey(defaultPathset)
 ...
 */
export function getItemPriceModifiers(key: number | string): [boolean, any] {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getItemTagTags(key: number | string, tagType: number | string): [number, any] {
    if (typeof key === 'string') key = GetHashKey(key)
    if (typeof tagType === 'string') tagType = GetHashKey(tagType)
 ...
 */
export function getItemTagType(item: number | string, tag: number | string): number {
    if (typeof item === 'string') item = GetHashKey(item)
    if (typeof tag === 'string') tag = GetHashKey(tag)
 ...
 */
export function getModifiedPrice(key: number | string, index: number): number {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getNumberOfModifiedPrices(key: number | string): number {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getNumberOfModifiers(key: number | string): number {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getPriorityAccessAward(award: number | string): boolean {
    if (typeof award === 'string') award = GetHashKey(award)
 ...
 */
export function getShopInventoriesItemsCount(shopType: number | string): number {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
 ...
 */
export function getShopInventoriesItemInfo(shopType: number | string, index: number): [boolean, any] {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
 ...
 */
export function getShopInventoriesItemInfoByKey(shopType: number | string, key: number | string): [boolean, any] {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getShopInventoriesRequirementGroupInfo(shopType: number | string, key: number | string, index: number): [boolean, any] {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getShopInventoriesRequirementInfo(shopType: number | string, key: number | string, groupIndex: number, index: number): [boolean, any] {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function getShopLayoutInfo(layout: number | string): [boolean, any] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
 ...
 */
export function getShopLayoutMenuInfoById(layout: number | string, menu: number | string): [boolean, any] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
 ...
 */
export function getShopLayoutMenuInfoByIndex(layout: number | string, menu: number | string, index: number): [boolean, any] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
    if (typeof menu === 'string') menu = GetHashKey(menu)
 ...
 */
export function getShopLayoutMenuPageKey(layout: number | string, menu: number | string, index: number): [boolean, number] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
    if (typeof menu === 'string') menu = GetHashKey(menu)
 ...
 */
export function getShopLayoutPageInfoByIndex(layout: number | string, index: number): [boolean, number] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
 ...
 */
export function getShopLayoutPageInfoByKey(layout: number | string, pageKey: number | string): [boolean, any] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
    if (typeof pageKey === 'string') pageKey = GetHashKey(pageKey)
 ...
 */
export function getShopLayoutPageItemKey(layout: number | string, pageKey: number | string, index: number): [boolean, number, number, number] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
    if (typeof pageKey === 'string') pageKey = GetHashKey(pageKey)
 ...
 */
export function getShopLayoutRootMenuInfo(layout: number | string, index: number): [boolean, any] {
    if (typeof layout === 'string') layout = GetHashKey(layout)
 ...
 */
export function isBundleValid(bundle: number | string, mode: number): boolean {
    if (typeof bundle === 'string') bundle = GetHashKey(bundle)
 ...
 */
export function isIntrinsicItem(key: number | string): boolean {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function isKeyValid(key: number | string, mode: number): boolean {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function isOverpoweredItem(key: number | string): boolean {
    if (typeof key === 'string') key = GetHashKey(key)
 ...
 */
export function isShopKeyValid(shopType: number | string): boolean {
    if (typeof shopType === 'string') shopType = GetHashKey(shopType)
 ...
 */
export function isShopLayoutKeyValid(layout: number | string): boolean {
    if (typeof layout === 'string') layout = GetHashKey(layout)
 ...
 */
export function localizationGetNumLabelTypes(): number {
 ...
 */
export function localizationGetNumValues(): number {
 ...
 */
export function localizationGetType(): any {
 ...
 */
export function localizationGetValue(label: number | string): number {
    if (typeof label === 'string') label = GetHashKey(label)
