 ...
 * };
 *
 * Hash: 0x7D6F58F69DA92530 | Since: 1207 | API-Set: unknown
 */
export function addExplosion(pos, explosionType, damageScale, isAudible, isInvisible, cameraShake) {
 ...
 *
 * Hash: 0x53BA259F3A67A99E | Since: 1207 | API-Set: unknown
 */
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0xD84A917A64D4D016 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0xB646FB657F448261 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0xF9617BC6FAE61E08 | Since: 1207 | API-Set: unknown
 */
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0x8002DDAB58594D78 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0x1BD7C371CE257C3E | Since: 1207 | API-Set: unknown
 */
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0xD96E82AEBFFAAFF0 | Since: 1207 | API-Set: unknown
 */
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0x5AE661ECD18524C9 | Since: 1207 | API-Set: unknown
 */
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0x8391BA4313A25AD3 | Since: 1207 | API-Set: unknown
 */
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0xD62DD846D82CBB90 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0x790125C36E194069 | Since: 1207 | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0xC4DC7418A44D6822 | Since: 1207 | API-Set: unknown
 */
export function startEntity(entity, intensity, boneIndex, fireFlags) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 *
 * Hash: 0x6B83617E04503888 | Since: 1207 | API-Set: unknown
 */
export function startScript(pos, soundsetName) {
    return StartScriptFire(pos.x, pos.y, pos.z, 0, 0, false, soundsetName, 0, 0);
}
/**
 * No comment provided
 *
 * Hash: 0x8390751DC40C1E98 | Since: 1207 | API-Set: unknown
 */
export function stopEntity() {
    StopEntityFire(undefined, undefined);
}
/**
 * No comment provided
 *
 * Hash: 0xDB38F247BD421708 | Since: 1207 | API-Set: unknown
 */
 ...
 *
 * Hash: 0x24DB6B9F2B719043 | Since: 1207 | API-Set: unknown
 */
export function _0x24DB6B9F2B719043() {
    Citizen.invokeNative('0x24DB6B9F2B719043', 0);
}
/**
 * No comment provided
 *
 * Hash: 0x41B87A6495EE13DD | Since: 1232 | API-Set: unknown
 */
export function _0x41B87A6495EE13DD() {
 ...
 * No comment provided
 *
 * Hash: 0x68F6A75FDF5A70D6 | Since: 1207 | API-Set: unknown
 */
export function _0x68F6A75FDF5A70D6(pos) {
    Citizen.invokeNative('0x68F6A75FDF5A70D6', pos.x, pos.y, pos.z, 0);
}
/**
 * No comment provided
 *
 * Hash: 0x754937C28271BC65 | Since: 1207 | API-Set: unknown
 */
export function _0x754937C28271BC65() {
 ...
 *
 * Hash: 0xB7DF150605EEDC9B | Since: 1207 | API-Set: unknown
 */
export function addExplosionWithDamageCauser(entity, pos, explosionType, damageScale, isAudible, isInvisible, cameraShake) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 *
 * Hash: 0x34AE85C7CA4857AA | Since: 1207 | API-Set: unknown
 */
export function addExplosionWithUserVfxAndDamageCauser(entity, pos, explosionType, explosionFx, damageScale, isAudible, isInvisible, cameraShake) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof explosionFx === 'string')
        explosionFx = GetHashKey(explosionFx);
 ...
 * No comment provided
 *
 * Hash: 0x559FC1D310813031 | Since: 1232 | API-Set: unknown
 */
export function getClosestPosInVolume(pos, rot, scale) {
    return Citizen.invokeNative('0x559FC1D310813031', pos.x, pos.y, pos.z, rot.x, rot.y, rot.z, scale.x, scale.y, scale.z);
}
/**
 * No comment provided
 *
 * Hash: 0xCDC25355C0D65963 | Since: 1207 | API-Set: unknown
 */
export function isEntityConsumedBy(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 *
 * Hash: 0xA4454592DCF7C992 | Since: 1207 | API-Set: unknown
 */
export function isEntityDamagedBy(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 * explosionType: see ADD_EXPLOSION
 *
 * Hash: 0xE24822A4CFC9107A | Since: 1207 | API-Set: unknown
 */
 ...
 *
 * Hash: 0xAB7993BA61A4674F | Since: 1232 | API-Set: unknown
 */
export function isPedShockingEventActive(ped) {
    const _ped = ped instanceof IPed ? ped.handle() : ped;
 ...
 * No comment provided
 *
 * Hash: 0xB7C7BDC375AEA9A4 | Since: 1207 | API-Set: unknown
 */
export function stopInBox(pos, rot, scale) {
