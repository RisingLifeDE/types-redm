 ...
 */
export function blipAddForCoords(blipHash, pos) {
    if (typeof blipHash === 'string')
        blipHash = GetHashKey(blipHash);
 ...
 */
export function blipAddForRadius(blipHash, pos, radius) {
    if (typeof blipHash === 'string')
        blipHash = GetHashKey(blipHash);
...
export function blipAddModifier(blip, modifierHash) {
    ...
    if (typeof modifierHash === 'string')
        modifierHash = GetHashKey(modifierHash);
 ...
 */
export function isBlipOnMini(blip) {
    const _blip = blip instanceof IBlip ? blip.handle() : blip;
 ...
 */
export function lockMiniAngle(angle) {
 ...
 */
export function resetMiniFow(hash) {
 ...
 */
export function setBlipNameFromTextFile(blip) {
    const _blip = blip instanceof IBlip ? blip.handle() : blip;
 ...
 */
export function setBlipSprite(blip, hash) {
    const _blip = blip instanceof IBlip ? blip.handle() : blip;
    if (typeof hash === 'string')
        hash = GetHashKey(hash);
 ...
 */
export function setGpsCustomRouteRender() {
 ...
 */
export function setMiniFowRevealCoordinate(pos, p3) {
    if (typeof p3 === 'string')
        p3 = GetHashKey(p3);
 ...
 */
export function setMiniFowRevealVolume(volume, p1) {
    if (typeof p1 === 'string')
        p1 = GetHashKey(p1);
 ...
 */
export function setMiniHideFow(toggle) {
 ...
 */
export function triggerSonarBlip(typeHash, pos) {
 ...
 */
export function unlockMiniAngle() {
    UnlockMinimapAngle();
}
/**
 * No comment provided
 ...
 */
export function _0xD3F58E9316B7FC2A() {
 ...
 */
export function addPropToMini(minimapProp, x, y, rotation, variation) {
    if (typeof minimapProp === 'string')
        minimapProp = GetHashKey(minimapProp);
 ...
 */
export function blipAddForArea(blipHash, pos, scale) {
    if (typeof blipHash === 'string')
        blipHash = GetHashKey(blipHash);
 ...
 */
export function blipDetachFromEntity(blip) {
    const _blip = blip instanceof IBlip ? blip.handle() : blip;
 ...
 */
export function clearBlip(blip) {
    const _blip = blip instanceof IBlip ? blip.handle() : blip;
 ...
 */
export function clearBlipIconFromLockonEntityPrompt(entity, blip) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function clearPauseCoords() {
 ...
 */
export function findClosestGpsPosition(pos) {
 ...
 */
export function getWaypointPosition() {
 ...
 */
export function isBlipIconOnLockonEntityPrompt(entity, blip) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function isGpsRouteOnRoad() {
 ...
 */
export function disableRegionBlip(regionHash) {
 ...
 */
export function discoverySetEnabled(discoveryHash) {
 ...
 */
export function discoverRegion(discoveryHash) {
    if (typeof discoveryHash === 'string')
        discoveryHash = GetHashKey(discoveryHash);
 ...
 */
export function enableRegionBlip(regionHash, styleHash) {
    if (typeof regionHash === 'string')
        regionHash = GetHashKey(regionHash);
    if (typeof styleHash === 'string')
        styleHash = GetHashKey(styleHash);
 ...
 */
export function isDiscoveryActive(discoveryHash) {
    if (typeof discoveryHash === 'string')
        discoveryHash = GetHashKey(discoveryHash);
 ...
 */
export function isRegionHighlightedWithStyle(regionHash, styleHash) {
    if (typeof regionHash === 'string')
        regionHash = GetHashKey(regionHash);
    if (typeof styleHash === 'string')
        styleHash = GetHashKey(styleHash);
 ...
 */
export function removeBlipIconFromEntityLockonPrompt(entity) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function removePropFromMini(minimapProp) {
    if (typeof minimapProp === 'string')
        minimapProp = GetHashKey(minimapProp);
 ...
 */
export function revealMiniFow(hash) {
    if (typeof hash === 'string')
        hash = GetHashKey(hash);
 ...
 */
export function setBlipIconOnEntityActivePrompt(entity, blipIcon) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof blipIcon === 'string')
        blipIcon = GetHashKey(blipIcon);
 ...
 */
export function setBlipIconToLockonEntityPrompt(entity, blipIcon) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
    if (typeof blipIcon === 'string')
        blipIcon = GetHashKey(blipIcon);
 ...
 */
export function setBlipName(blip) {
    const _blip = blip instanceof IBlip ? blip.handle() : blip;
 ...
 */
export function setEntityBlipIconToLockonEntityPrompt(entity, blipId) {
    const _entity = entity instanceof IEntity ? entity.handle() : entity;
 ...
 */
export function setMiniFowOverrideRevealScale(scale, p1) {
    if (typeof p1 === 'string')
        p1 = GetHashKey(p1);
 ...
 */
export function setMiniFowShouldUpdate(toggle, p1) {
    if (typeof p1 === 'string')
        p1 = GetHashKey(p1);
 ...
 */
export function setMiniZone(zone) {
    if (typeof zone === 'string')
        zone = GetHashKey(zone);
    SetMinimapZone(zone);
}
/**
 * No comment provided
 ...
 */
export function setPauseCoordsWithRadius(pos, radius) {
 ...
 */
export function startGpsCustomRouteFromWaypointRecordingRoute(point, numPoints, colorNameHash) {
    if (typeof colorNameHash === 'string')
        colorNameHash = GetHashKey(colorNameHash);
