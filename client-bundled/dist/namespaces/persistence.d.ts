 ...
 */
export declare function addScenarioLooted(scenario: number): void;
/**
 * No comment provided
 *
 * Hash: 0x9D16896F0DBE78A2 | Since: 1207 | API-Set: unknown
 */
export declare function removeAllEntitiesInArea(pos: Vector3, radius: number): void;
/**
 * No comment provided
 *
 ...
 */
export declare function isScenarioMarkedAsLooted(scenario: number): boolean;
/**
 * No comment provided
 *
 * Hash: 0xB6E1A185C2B9319A | Since: 1207 | API-Set: unknown
 */
export declare function isScenarioMarkedAsLootedAtCoords(pos: Vector3): boolean;
/**
 * No comment provided
 *
 * Hash: 0x188313616D184213 | Since: 1207 | API-Set: unknown
 */
export declare function isScenarioMarkedAsLootedAtCoordsWithModel(pos: Vector3, model: number | string): boolean;
/**
 ...
 */
export declare function refreshTownVolume(volume: number): void;
