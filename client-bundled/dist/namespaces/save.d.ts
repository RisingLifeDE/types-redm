 ...
 */
export declare function gameIsSavePending(): boolean;
/**
 * See SAVEGAME_SAVE_SP
 *
 * Hash: 0x1840F3B30ED0105F | Since: 1207 | API-Set: unknown
 */
export declare function gameSaveMp(savegameType: number | string): boolean;
/**
 ...
 */
export declare function gameSaveSp(savegameType: number | string): boolean;
/**
 * No comment provided
 *
 ...
 */
export declare function gameGetBool(): [any, string];
/**
 * No comment provided
 *
 * Hash: 0x35DEFECAE36D4FAE | Since: 1207 | API-Set: unknown
 */
export declare function gameGetFloat(variableName: string): any;
/**
 * No comment provided
 *
 * Hash: 0x529B9CCD0972AF4E | Since: 1207 | API-Set: unknown
 */
export declare function gameGetInt(variableName: string): any;
/**
 * Does the exact same as 0x529B9CCD0972AF4E
 ...
 */
export declare function gameGetInt2(variableName: string): any;
/**
 * Does the exact same as 0x529B9CCD0972AF4E
 ...
 */
export declare function gameGetInt3(variableName: string): any;
/**
 * No comment provided
 *
 * Hash: 0x5A10D6506B2F2C63 | Since: 1207 | API-Set: unknown
 */
export declare function gameGetTextLabel23(variableName: string): any;
/**
 * No comment provided
 *
 * Hash: 0x4845E7E7643A908C | Since: 1207 | API-Set: unknown
 */
export declare function gameGetTextLabel31(variableName: string): any;
/**
 * No comment provided
 *
 * Hash: 0x186608A2AC6F9E88 | Since: 1207 | API-Set: unknown
 */
export declare function gameGetTextLabel63(variableName: string): any;
/**
 * No comment provided
 *
 * Hash: 0x1431540BCA1A1BD2 | Since: 1207 | API-Set: unknown
 */
export declare function gameHasSaveFailed(): boolean;
